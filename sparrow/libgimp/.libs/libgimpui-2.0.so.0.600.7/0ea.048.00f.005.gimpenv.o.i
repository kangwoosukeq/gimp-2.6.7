# 1 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
# 23 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
# 1 "../config.h" 1
# 24 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 2
...
# 26 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 2
...
# 27 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 2
...
# 30 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 2
...
# 33 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 2
...
# 34 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 2
...
# 41 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 2

# 1 "/src/gimp-2.6.7/libgimpbase/gimpenv.h" 1
# 27 "/src/gimp-2.6.7/libgimpbase/gimpenv.h"

# 42 "/src/gimp-2.6.7/libgimpbase/gimpenv.h"
...
# 43 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 2
# 1 "/src/gimp-2.6.7/libgimpbase/gimpversion.h" 1
# 9 "/src/gimp-2.6.7/libgimpbase/gimpversion.h"

# 24 "/src/gimp-2.6.7/libgimpbase/gimpversion.h"

# 44 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 2
# 1 "/src/gimp-2.6.7/libgimpbase/gimpreloc.h" 1
# 16 "/src/gimp-2.6.7/libgimpbase/gimpreloc.h"
...
# 45 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 2
# 69 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
static gchar * gimp_env_get_dir (const gchar *gimp_env_name,
                                 const gchar *env_dir);


const guint gimp_major_version = (2);
const guint gimp_minor_version = (6);
const guint gimp_micro_version = (7);
# 88 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
void
gimp_env_init (gboolean plug_in)
{
  ...
  if (gimp_env_initialized)
    do { g_log ("LibGimpBase", G_LOG_LEVEL_ERROR, "gimp_env_init() must only be called once!"); for (;;) ; } while (0);
...
# 101 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                           ((void *)0)
# 101 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                               );
    }
  else if (_gimp_reloc_init (
# 103 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                            ((void *)0)
# 103 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                                ))
    {


      const gchar *ldpath = g_getenv ("LD_LIBRARY_PATH");
      gchar *libdir = _gimp_reloc_find_lib_dir (
# 108 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                                                     ((void *)0)
# 108 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                                                         );

      if (ldpath && *ldpath)
        {
          gchar *tmp = g_strconcat (libdir, ":", ldpath, 
# 112 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                                                        ((void *)0)
# 112 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                                                            );
...
# 152 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
const gchar *
gimp_directory (void)
{
  static gchar *gimp_dir = 
# 155 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                          ((void *)0)
# 155 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                              ;
...
# 178 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                                          ((void *)0)
# 178 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                                              );
            }
          else
            {
              gimp_dir = g_build_filename (gimp_data_directory (),
                                           env_gimp_dir, 
# 183 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                                                        ((void *)0)
# 183 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                                                            );
            }
        }
    }
  else
    {
      if (home_dir)
        {
          gimp_dir = g_build_filename (home_dir, ".gimp-2.6", 
# 191 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                                                         ((void *)0)
# 191 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                                                             );
        }
      else
        {
          ...
          gchar *subdir_name;
# 216 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
          g_log ("LibGimpBase", G_LOG_LEVEL_MESSAGE, "warning: no home directory.");

          subdir_name = g_strconcat (".gimp-2.6" ".", user_name, 
# 218 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                                                            ((void *)0)
# 218 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                                                                );
          gimp_dir = g_build_filename (gimp_data_directory (),
                                       subdir_name,
                                       
# 221 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                                      ((void *)0)
# 221 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                                          );
          g_free (user_name);
          g_free (subdir_name);
        }
...
# 258 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
static const gchar *
gimp_toplevel_directory (void)
{
  static gchar *toplevel = 
# 261 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                          ((void *)0)
# 261 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                              ;

  if (toplevel)
    return toplevel;
# 301 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
  toplevel = _gimp_reloc_find_prefix ("/usr/local");


  return toplevel;
}
# 323 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
const gchar *
gimp_data_directory (void)
{
  static gchar *gimp_data_dir = 
# 326 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                               ((void *)0)
# 326 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                                   ;
...
# 358 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
const gchar *
gimp_locale_directory (void)
{
  static gchar *gimp_locale_dir = 
# 361 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                                 ((void *)0)
# 361 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                                     ;
...
# 395 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
const gchar *
gimp_sysconf_directory (void)
{
  static gchar *gimp_sysconf_dir = 
# 398 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                                  ((void *)0)
# 398 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                                      ;
...
# 422 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
const gchar *
gimp_user_directory (GimpUserDirectory type)
{
  return g_get_user_special_dir (type);
}
# 444 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
const gchar *
gimp_plug_in_directory (void)
{
  static gchar *gimp_plug_in_dir = 
# 447 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                                  ((void *)0)
# 447 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                                      ;
...
# 473 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
gchar *
gimp_personal_rc_file (const gchar *basename)
{
  return g_build_filename (gimp_directory (), basename, 
# 476 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                                                       ((void *)0)
# 476 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                                                           );
}
# 491 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
const gchar *
gimp_gtkrc (void)
{
  static gchar *gimp_gtkrc_filename = 
# 494 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                                     ((void *)0)
# 494 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                                         ;
...
# 499 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                                           ((void *)0)
# 499 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                                               );

  return gimp_gtkrc_filename;
}
# 521 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
static void
gimp_path_runtime_fix (gchar **path)
{
# 557 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
  gchar *p;
...
# 568 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                               ((void *)0)
# 568 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                                   );
      g_free (p);
    }

}
# 584 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
GList *
                 ...
                 GList **check_failed)
{
  ...
  gchar **patharray;
  GList *list = 
# 592 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                           ((void *)0)
# 592 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                               ;
  GList *fail_list = 
# 593 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                           ((void *)0)
# 593 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                               ;
  gint i;
  gboolean exists = (!(0));
  ...
  if (!path || !*path || max_paths < 1 || max_paths > 256)
    return 
# 598 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
          ((void *)0)
# 598 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
              ;
...
{
  GString *str = 
# 657 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                   ((void *)0)
# 657 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                       ;
  GList *list;
  gchar *retval = 
# 659 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                   ((void *)0)
# 659 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                       ;

  for (list = path; list; list = ((list) ? (((GList *)(list))->next) : 
# 661 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                                ((void *)0)
# 661 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                                ))
    {
      gchar *dir = list->data;
...
# 689 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
void
gimp_path_free (GList *path)
{
  g_list_foreach (path, (GFunc) g_free, 
# 692 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                                       ((void *)0)
# 692 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                                           );
  g_list_free (path);
}
# 704 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
gchar *
...
# 713 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
 ((void *)0)
# 713 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimpBase", ((const char*) (__func__)), "path != NULL"); return (
# 713 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
 ((void *)0)
# 713 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
 ); }; }while (0);
  ...
  for (list = path; list; list = ((list) ? (((GList *)(list))->next) : 
# 718 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                                ((void *)0)
# 718 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                                ))
    {
      gchar *dir = list->data;
      ...
      if (!err && 
# 730 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                 ((((
# 730 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                 filestat.st_mode
# 730 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                 )) & 0170000) == (0040000)) 
# 730 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
          ...
          ((filestat.st_mode & 
# 732 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                              0200
# 732 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                                     ) ||

           ((filestat.st_mode & 
# 734 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                               (0200 >> 3)
# 734 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                                      ) &&
            (euid != filestat.st_uid)) ||

           ((filestat.st_mode & 
# 737 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
                               ((0200 >> 3) >> 3)
# 737 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
                                      ) &&
            (euid != filestat.st_uid) &&
  ...
  return 
# 745 "/src/gimp-2.6.7/libgimpbase/gimpenv.c" 3 4
        ((void *)0)
# 745 "/src/gimp-2.6.7/libgimpbase/gimpenv.c"
            ;
}
  ...
  if (env)
    {
      if (! g_path_is_absolute (env))
        do { g_log ("LibGimpBase", G_LOG_LEVEL_ERROR, "%s environment variable should be an absolute path.", gimp_env_name); for (;;) ; } while (0)
                               ;
