# 1 "/src/gimp-2.6.7/libgimp/gimpbrushes_pdb.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/libgimp/gimpbrushes_pdb.c"
# 24 "/src/gimp-2.6.7/libgimp/gimpbrushes_pdb.c"
# 1 "../config.h" 1
# 25 "/src/gimp-2.6.7/libgimp/gimpbrushes_pdb.c" 2
...
# 27 "/src/gimp-2.6.7/libgimp/gimpbrushes_pdb.c" 2
...
# 29 "/src/gimp-2.6.7/libgimp/gimpbrushes_pdb.c" 2


# 1 "/src/gimp-2.6.7/libgimp/gimpbrushes_pdb.h" 1
# 27 "/src/gimp-2.6.7/libgimp/gimpbrushes_pdb.h"
...
# 32 "/src/gimp-2.6.7/libgimp/gimpbrushes_pdb.c" 2
# 43 "/src/gimp-2.6.7/libgimp/gimpbrushes_pdb.c"
gboolean
...
# 74 "/src/gimp-2.6.7/libgimp/gimpbrushes_pdb.c"
gchar **
                       ...
                       gint *num_brushes)
{
  ...
  gint nreturn_vals;
  gchar **brush_list = 
# 80 "/src/gimp-2.6.7/libgimp/gimpbrushes_pdb.c" 3 4
                      ((void *)0)
# 80 "/src/gimp-2.6.7/libgimp/gimpbrushes_pdb.c"
                          ;
  gint i;
  ...
  if (return_vals[0].data.d_status == GIMP_PDB_SUCCESS)
    {
      *num_brushes = return_vals[1].data.d_int32;
      brush_list = (gchar * *) (__extension__ ({ gsize __n = (gsize) (*num_brushes); gsize __s = sizeof (gchar *); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 93 "/src/gimp-2.6.7/libgimp/gimpbrushes_pdb.c" 3 4
                  (0x7fffffffffffffffL * 2UL + 1UL) 
# 93 "/src/gimp-2.6.7/libgimp/gimpbrushes_pdb.c"
...
# 113 "/src/gimp-2.6.7/libgimp/gimpbrushes_pdb.c"
gchar *
                        ...
                        gint *spacing)
{
  ...
  gint nreturn_vals;
  gchar *name = 
# 120 "/src/gimp-2.6.7/libgimp/gimpbrushes_pdb.c" 3 4
               ((void *)0)
# 120 "/src/gimp-2.6.7/libgimp/gimpbrushes_pdb.c"
                   ;
...
# 146 "/src/gimp-2.6.7/libgimp/gimpbrushes_pdb.c"
gint
...
# 173 "/src/gimp-2.6.7/libgimp/gimpbrushes_pdb.c"
gboolean
...
# 207 "/src/gimp-2.6.7/libgimp/gimpbrushes_pdb.c"
gchar *
                             ...
                             guint8 **mask_data)
{
  ...
  gint nreturn_vals;
  gchar *actual_name = 
# 219 "/src/gimp-2.6.7/libgimp/gimpbrushes_pdb.c" 3 4
                      ((void *)0)
# 219 "/src/gimp-2.6.7/libgimp/gimpbrushes_pdb.c"
                          ;
  ...
  if (return_vals[0].data.d_status == GIMP_PDB_SUCCESS)
    {
      ...
      *mask_data = (guint8 *) (__extension__ ({ gsize __n = (gsize) (*length); gsize __s = sizeof (guint8); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 237 "/src/gimp-2.6.7/libgimp/gimpbrushes_pdb.c" 3 4
                  (0x7fffffffffffffffL * 2UL + 1UL) 
# 237 "/src/gimp-2.6.7/libgimp/gimpbrushes_pdb.c"
                  / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
      memcpy (*mask_data,
