# 1 "/src/gimp-2.6.7/libgimp/gimpgimprc.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/libgimp/gimpgimprc.c"
# 22 "/src/gimp-2.6.7/libgimp/gimpgimprc.c"
# 1 "../config.h" 1
# 23 "/src/gimp-2.6.7/libgimp/gimpgimprc.c" 2
...
# 25 "/src/gimp-2.6.7/libgimp/gimpgimprc.c" 2
# 37 "/src/gimp-2.6.7/libgimp/gimpgimprc.c"
GimpColorConfig *
gimp_get_color_configuration (void)
{
  ...
  gchar *text;
  GError *error = 
# 42 "/src/gimp-2.6.7/libgimp/gimpgimprc.c" 3 4
                          ((void *)0)
# 42 "/src/gimp-2.6.7/libgimp/gimpgimprc.c"
                              ;

  text = _gimp_get_color_configuration ();

  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((text != 
# 46 "/src/gimp-2.6.7/libgimp/gimpgimprc.c" 3 4
 ((void *)0)
# 46 "/src/gimp-2.6.7/libgimp/gimpgimprc.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimp", ((const char*) (__func__)), "text != NULL"); return (
# 46 "/src/gimp-2.6.7/libgimp/gimpgimprc.c" 3 4
 ((void *)0)
# 46 "/src/gimp-2.6.7/libgimp/gimpgimprc.c"
 ); }; }while (0);

  config = g_object_new ((gimp_color_config_get_type ()), 
# 48 "/src/gimp-2.6.7/libgimp/gimpgimprc.c" 3 4
                                                ((void *)0)
# 48 "/src/gimp-2.6.7/libgimp/gimpgimprc.c"
                                                    );

  if (! gimp_config_deserialize_string (((((GimpConfig*) g_type_check_instance_cast ((GTypeInstance*) ((config)), ((gimp_config_interface_get_type ())))))), text, -1, 
# 50 "/src/gimp-2.6.7/libgimp/gimpgimprc.c" 3 4
                                                                       ((void *)0)
# 50 "/src/gimp-2.6.7/libgimp/gimpgimprc.c"
                                                                           ,
                                        &error))
    {
      g_log ("LibGimp", G_LOG_LEVEL_WARNING, "failed to deserialize color configuration: %s", error->message)
                                ;
      g_error_free (error);
    }
