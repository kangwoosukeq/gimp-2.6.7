# 1 "/src/gimp-2.6.7/libgimpbase/gimpbasetypes.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/libgimpbase/gimpbasetypes.c"
# 23 "/src/gimp-2.6.7/libgimpbase/gimpbasetypes.c"
# 1 "../config.h" 1
# 24 "/src/gimp-2.6.7/libgimpbase/gimpbasetypes.c" 2
...
# 26 "/src/gimp-2.6.7/libgimpbase/gimpbasetypes.c" 2
...
# 28 "/src/gimp-2.6.7/libgimpbase/gimpbasetypes.c" 2
...
# 46 "/src/gimp-2.6.7/libgimpbase/gimpbasetypes.c"
void
...
# 68 "/src/gimp-2.6.7/libgimpbase/gimpbasetypes.c"
const gchar *
...
# 85 "/src/gimp-2.6.7/libgimpbase/gimpbasetypes.c"
void
gimp_enum_set_value_descriptions (GType enum_type,
                                  const GimpEnumDesc *descriptions)
{
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((g_type_is_a (enum_type, ((GType) ((12) << (2)))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimpBase", ((const char*) (__func__)), "g_type_is_a (enum_type, G_TYPE_ENUM)"); return; }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((descriptions != 
# 90 "/src/gimp-2.6.7/libgimpbase/gimpbasetypes.c" 3 4
 ((void *)0)
# 90 "/src/gimp-2.6.7/libgimpbase/gimpbasetypes.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimpBase", ((const char*) (__func__)), "descriptions != NULL"); return; }; }while (0);

  g_type_set_qdata (enum_type,
                    gimp_value_descriptions_quark (),
                    (gpointer) descriptions);
}
# 108 "/src/gimp-2.6.7/libgimpbase/gimpbasetypes.c"
const GimpEnumDesc *
gimp_enum_get_value_descriptions (GType enum_type)
{
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((g_type_is_a (enum_type, ((GType) ((12) << (2)))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimpBase", ((const char*) (__func__)), "g_type_is_a (enum_type, G_TYPE_ENUM)"); return (
# 111 "/src/gimp-2.6.7/libgimpbase/gimpbasetypes.c" 3 4
 ((void *)0)
# 111 "/src/gimp-2.6.7/libgimpbase/gimpbasetypes.c"
 ); }; }while (0);

  return (const GimpEnumDesc *)
    g_type_get_qdata (enum_type, gimp_value_descriptions_quark ());
}
# 127 "/src/gimp-2.6.7/libgimpbase/gimpbasetypes.c"
void
gimp_flags_set_value_descriptions (GType flags_type,
                                   const GimpFlagsDesc *descriptions)
{
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((g_type_is_a (flags_type, ((GType) ((13) << (2)))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimpBase", ((const char*) (__func__)), "g_type_is_a (flags_type, G_TYPE_FLAGS)"); return; }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((descriptions != 
# 132 "/src/gimp-2.6.7/libgimpbase/gimpbasetypes.c" 3 4
 ((void *)0)
# 132 "/src/gimp-2.6.7/libgimpbase/gimpbasetypes.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimpBase", ((const char*) (__func__)), "descriptions != NULL"); return; }; }while (0);
...
# 150 "/src/gimp-2.6.7/libgimpbase/gimpbasetypes.c"
const GimpFlagsDesc *
gimp_flags_get_value_descriptions (GType flags_type)
{
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((g_type_is_a (flags_type, ((GType) ((13) << (2)))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimpBase", ((const char*) (__func__)), "g_type_is_a (flags_type, G_TYPE_FLAGS)"); return (
# 153 "/src/gimp-2.6.7/libgimpbase/gimpbasetypes.c" 3 4
 ((void *)0)
# 153 "/src/gimp-2.6.7/libgimpbase/gimpbasetypes.c"
 ); }; }while (0);
