# 1 "/src/gimp-2.6.7/tools/gimptool.c"
# 1 "/src/gimp-2.6.7/tools//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/tools/gimptool.c"
# 30 "/src/gimp-2.6.7/tools/gimptool.c"
...
# 31 "/src/gimp-2.6.7/tools/gimptool.c" 2
...
# 32 "/src/gimp-2.6.7/tools/gimptool.c" 2
...
# 33 "/src/gimp-2.6.7/tools/gimptool.c" 2
...
# 35 "/src/gimp-2.6.7/tools/gimptool.c" 2
...
# 37 "/src/gimp-2.6.7/tools/gimptool.c" 2
...
# 39 "/src/gimp-2.6.7/tools/gimptool.c" 2
...
# 71 "/src/gimp-2.6.7/tools/gimptool.c"
static struct {
  const gchar *option;
  const gchar *value;
} dirs[] = {
...
# 113 "/src/gimp-2.6.7/tools/gimptool.c"
static gboolean
starts_with_dir (const gchar *string,
   const gchar *test)
{
  return g_str_has_prefix (string, g_strconcat (test, "/", 
# 117 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
                                                          ((void *)0)
# 117 "/src/gimp-2.6.7/tools/gimptool.c"
                                                              )) ||
...
one_line_output (const gchar *program,
   const gchar *args)
{
  gchar *command = g_strconcat (program, " ", args, 
# 125 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
                                                   ((void *)0)
# 125 "/src/gimp-2.6.7/tools/gimptool.c"
                                                       );
  FILE *pipe = popen (command, "r");
  gchar line[1000];

  if (pipe == 
# 129 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
             ((void *)0)
# 129 "/src/gimp-2.6.7/tools/gimptool.c"
                 )
    {
      g_printerr ("Cannot run '%s'\n", command);
      exit (
# 132 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
           1
# 132 "/src/gimp-2.6.7/tools/gimptool.c"
                       );
    }

  if (fgets (line, sizeof (line), pipe) == 
# 135 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
                                          ((void *)0)
# 135 "/src/gimp-2.6.7/tools/gimptool.c"
                                              )
    line[0] = '\0';
  ...
  if (strlen (line) == 0)
    {
      ...
      exit (
# 148 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
           1
# 148 "/src/gimp-2.6.7/tools/gimptool.c"
                       );
    }
...
{
# 209 "/src/gimp-2.6.7/tools/gimptool.c"
...
{
# 226 "/src/gimp-2.6.7/tools/gimptool.c"
  return "/usr/local";
...
expand_and_munge (const gchar *value)
{
  ...
  if (starts_with_dir (value, "${prefix}"))
    retval = g_strconcat ("/usr/local", value + strlen ("${prefix}"), 
# 236 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
                                                               ((void *)0)
# 236 "/src/gimp-2.6.7/tools/gimptool.c"
                                                                   );
  else if (starts_with_dir (value, "${exec_prefix}"))
    retval = g_strconcat ("/usr/local", value + strlen ("${exec_prefix}"), 
# 238 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
                                                                         ((void *)0)
# 238 "/src/gimp-2.6.7/tools/gimptool.c"
                                                                             );
  else
    retval = g_strdup (value);

  if (starts_with_dir (retval, "/usr/local"))
    retval = g_strconcat (get_exec_prefix ('/'), retval + strlen ("/usr/local"), 
# 243 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
                                                                               ((void *)0)
# 243 "/src/gimp-2.6.7/tools/gimptool.c"
                                                                                   );

  if (starts_with_dir (retval, "/usr/local"))
    retval = g_strconcat (get_runtime_prefix ('/'), retval + strlen ("/usr/local"), 
# 246 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
                                                                             ((void *)0)
# 246 "/src/gimp-2.6.7/tools/gimptool.c"
                                                                                 );
...
find_out_env_flags (void)
{
  ...
  if ((p = getenv ("CC")) != 
# 256 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
                            ((void *)0) 
# 256 "/src/gimp-2.6.7/tools/gimptool.c"
                                 && *p != '\0')
    env_cc = p;
  else if (msvc_syntax)
    env_cc = "cl -MD";
  ...
  if ((p = getenv ("CFLAGS")) != 
# 266 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
                                ((void *)0)
# 266 "/src/gimp-2.6.7/tools/gimptool.c"
                                    )
    env_cflags = p;
  else
    env_cflags = "";
  ...
  if ((p = getenv ("LDFLAGS")) != 
# 271 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
                                 ((void *)0)
# 271 "/src/gimp-2.6.7/tools/gimptool.c"
                                     )
    env_ldflags = p;
  else
    env_ldflags = "";
  ...
  if ((p = getenv ("LIBS")) != 
# 276 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
                              ((void *)0) 
# 276 "/src/gimp-2.6.7/tools/gimptool.c"
                                   && *p != '\0')
    env_libs = p;
  else
    env_libs = "";
...
# 333 "/src/gimp-2.6.7/tools/gimptool.c"
  exit (exit_status);
}
     ...
     const gchar *what)
{
  ...
  if (install_dir != 
# 444 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
                    ((void *)0)
# 444 "/src/gimp-2.6.7/tools/gimptool.c"
                        )
    dest_dir = g_strconcat (install_dir, "/", 
# 445 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
                                             ((void *)0)
# 445 "/src/gimp-2.6.7/tools/gimptool.c"
                                                 );
  else
    dest_dir = "";
  ...
  p = strrchr (dest_exe, '.');
  if (p == 
# 452 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
          ((void *)0) 
# 452 "/src/gimp-2.6.7/tools/gimptool.c"
               ||
      !(strcmp (p, ".c") == 0 ||
        strcmp (p, ".cc") == 0 ||
        strcmp (p, ".cpp") == 0))
    {
      ...
      exit (
# 458 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
           1
# 458 "/src/gimp-2.6.7/tools/gimptool.c"
                       );
    }
  ...
  *p = '\0';
  ...
  if (q == 
# 470 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
          ((void *)0)
# 470 "/src/gimp-2.6.7/tools/gimptool.c"
              )
    q = dest_exe;
  else
    q++;

  dest_exe = g_strconcat (q, "", 
# 475 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
                                    ((void *)0)
# 475 "/src/gimp-2.6.7/tools/gimptool.c"
                                        );
...
{
  do_build_2 (get_cflags (), get_libs (), 
# 510 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
                                         ((void *)0)
# 510 "/src/gimp-2.6.7/tools/gimptool.c"
                                             , what);
}
...
{
  do_build_2 (get_cflags_noui (), get_libs_noui (), 
# 516 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
                                                   ((void *)0)
# 516 "/src/gimp-2.6.7/tools/gimptool.c"
                                                       , what);
}
...
{
# 536 "/src/gimp-2.6.7/tools/gimptool.c"
  const gchar slash = '/';


  return g_strdup_printf ("%s%c" ".gimp-2.6" "%cplug-ins",
...
{
  do_build_2 (get_cflags (), get_libs (), get_user_plugin_dir ((0)), what);
}

static void
do_install_noui (const gchar *what)
{
  do_build_2 (get_cflags_noui (), get_libs_noui (), get_user_plugin_dir ((0)), what);
}
...
get_sys_plugin_dir (gboolean forward_slashes)
{
  ...
  return g_strdup_printf ("%s%clib%cgimp%c" "2.0" "%cplug-ins",
...
# 598 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
                       0400 
# 598 "/src/gimp-2.6.7/tools/gimptool.c"
                               | 
# 598 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
                                 0100 
# 598 "/src/gimp-2.6.7/tools/gimptool.c"
...
# 599 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
                       (0400 >> 3) 
# 599 "/src/gimp-2.6.7/tools/gimptool.c"
                               | 
# 599 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
                                 (0100 >> 3) 
# 599 "/src/gimp-2.6.7/tools/gimptool.c"
...
# 600 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
                       ((0400 >> 3) >> 3) 
# 600 "/src/gimp-2.6.7/tools/gimptool.c"
                               | 
# 600 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
                                 ((0100 >> 3) >> 3)
# 600 "/src/gimp-2.6.7/tools/gimptool.c"
  ...
  maybe_run (g_strconcat ("cp", " ", what, " ", dir, 
# 602 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
                                                    ((void *)0)
# 602 "/src/gimp-2.6.7/tools/gimptool.c"
                                                        ));
}
...
{
  do_install_bin_2 (get_user_plugin_dir ((0)), what);
}
...
do_uninstall (const gchar *dir,
       const gchar *what)
{
  maybe_run (g_strconcat ("rm -f", " ", dir, "/", what, 
# 621 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
                                                                    ((void *)0)
# 621 "/src/gimp-2.6.7/tools/gimptool.c"
                                                                        ));
}
...
{
  do_uninstall (get_user_plugin_dir ((0)), maybe_append_exe (what));
}
...
get_user_script_dir (gboolean forward_slashes)
{
  ...
  return g_strdup_printf ("%s%c" ".gimp-2.6" "%cscripts",
     g_get_home_dir (), slash, slash);
}
...
{
  do_install_bin_2 (get_user_script_dir ((0)), what);
}
...
{
  do_install_bin_2 (get_sys_script_dir ((0)), what);
}

static void
do_uninstall_script (const gchar *what)
{
  do_uninstall (get_user_script_dir ((0)), what);
}

static void
do_uninstall_admin_script (const gchar *what)
{
  do_uninstall (get_sys_script_dir ((0)), what);
}
      ...
      char **argv)
{
  ...
  if (argc == 1)
    usage (
# 710 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
          0
# 710 "/src/gimp-2.6.7/tools/gimptool.c"
                      );
  ...
  while (++argi < argc)
   ...
   strcmp (argv[argi], "--recon") == 0)
        ...
        {
          usage (
# 727 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
                0
# 727 "/src/gimp-2.6.7/tools/gimptool.c"
                            );
        }
  ...
  while (++argi < argc)
    {
      for (i = 0; i < (sizeof (dirs) / sizeof ((dirs)[0])); i++)
        {
          if (strcmp (argv[argi],
                      g_strconcat ("--", dirs[i].option, 
# 760 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
                                                        ((void *)0)
# 760 "/src/gimp-2.6.7/tools/gimptool.c"
                                                            )) == 0)
            break;
        }
      ...
      else if (strcmp (argv[argi], "--version") == 0)
 {
   g_print ("%d.%d.%d\n",
                   (2), (6), (7));
   exit (
# 777 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
        0
# 777 "/src/gimp-2.6.7/tools/gimptool.c"
                    );
 }
      ...
      else
 {
   ...
   usage (
# 841 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
         1
# 841 "/src/gimp-2.6.7/tools/gimptool.c"
                     );
 }
    }

  exit (
# 845 "/src/gimp-2.6.7/tools/gimptool.c" 3 4
       0
# 845 "/src/gimp-2.6.7/tools/gimptool.c"
                   );
}
