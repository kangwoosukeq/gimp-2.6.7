# 1 "/src/gimp-2.6.7/libgimpbase/gimpwire.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/libgimpbase/gimpwire.c"
# 20 "/src/gimp-2.6.7/libgimpbase/gimpwire.c"
# 1 "../config.h" 1
# 21 "/src/gimp-2.6.7/libgimpbase/gimpwire.c" 2
...
# 23 "/src/gimp-2.6.7/libgimpbase/gimpwire.c" 2
...
# 25 "/src/gimp-2.6.7/libgimpbase/gimpwire.c" 2
...
# 27 "/src/gimp-2.6.7/libgimpbase/gimpwire.c" 2
...
# 29 "/src/gimp-2.6.7/libgimpbase/gimpwire.c" 2
...
static GHashTable *wire_ht = 
# 42 "/src/gimp-2.6.7/libgimpbase/gimpwire.c" 3 4
                                           ((void *)0)
# 42 "/src/gimp-2.6.7/libgimpbase/gimpwire.c"
                                               ;
static GimpWireIOFunc wire_read_func = 
# 43 "/src/gimp-2.6.7/libgimpbase/gimpwire.c" 3 4
                                           ((void *)0)
# 43 "/src/gimp-2.6.7/libgimpbase/gimpwire.c"
                                               ;
static GimpWireIOFunc wire_write_func = 
# 44 "/src/gimp-2.6.7/libgimpbase/gimpwire.c" 3 4
                                           ((void *)0)
# 44 "/src/gimp-2.6.7/libgimpbase/gimpwire.c"
                                               ;
static GimpWireFlushFunc wire_flush_func = 
# 45 "/src/gimp-2.6.7/libgimpbase/gimpwire.c" 3 4
                                           ((void *)0)
# 45 "/src/gimp-2.6.7/libgimpbase/gimpwire.c"
                                               ;
...
gimp_wire_read (GIOChannel *channel,
                ...
                gpointer user_data)
{
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((count >= 0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimpBase", ((const char*) (__func__)), "count >= 0"); return ((0)); }; }while (0);

  if (wire_read_func)
    {
      if (!(* wire_read_func) (channel, buf, count, user_data))
        {
          g_log ("LibGimpBase", G_LOG_LEVEL_WARNING, "%s: gimp_wire_read: error", g_get_prgname ());
          wire_error_val = (!(0));
          return (0);
        }
    }
  else
    {
      GIOStatus status;
      GError *error = 
# 114 "/src/gimp-2.6.7/libgimpbase/gimpwire.c" 3 4
                        ((void *)0)
# 114 "/src/gimp-2.6.7/libgimpbase/gimpwire.c"
                            ;
      gsize bytes;
      ...
      while (count > 0)
        {
          ...
          while ((__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((status == G_IO_STATUS_AGAIN)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 0)));

          if ((__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((status != G_IO_STATUS_NORMAL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 0)))
            {
              if (error)
                {
                  g_log ("LibGimpBase", G_LOG_LEVEL_WARNING, "%s: gimp_wire_read(): error: %s", g_get_prgname (), error->message)
                                                              ;
                  g_error_free (error);
                }
              else
          ...
          if ((__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((bytes == 0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 0)))
            {
              g_log ("LibGimpBase", G_LOG_LEVEL_WARNING, "%s: gimp_wire_read(): unexpected EOF", g_get_prgname ())
                                          ;
              wire_error_val = (!(0));
              return (0);
            }
  ...
  if (wire_write_func)
    {
      if (!(* wire_write_func) (channel, (guint8 *) buf, count, user_data))
        {
          g_log ("LibGimpBase", G_LOG_LEVEL_WARNING, "%s: gimp_wire_write: error", g_get_prgname ());
          wire_error_val = (!(0));
          return (0);
        }
    }
  else
    {
      GIOStatus status;
      GError *error = 
# 183 "/src/gimp-2.6.7/libgimpbase/gimpwire.c" 3 4
                        ((void *)0)
# 183 "/src/gimp-2.6.7/libgimpbase/gimpwire.c"
                            ;
      gsize bytes;
          ...
          if ((__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((status != G_IO_STATUS_NORMAL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 0)))
            {
              if (error)
                {
                  g_log ("LibGimpBase", G_LOG_LEVEL_WARNING, "%s: gimp_wire_write(): error: %s", g_get_prgname (), error->message)
                                                              ;
                  g_error_free (error);
                }
              else
                    ...
                    gpointer user_data)
{
  ...
  if ((__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((! wire_ht)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 0)))
    do { g_log ("LibGimpBase", G_LOG_LEVEL_ERROR, "gimp_wire_read_msg: the wire protocol has not been initialized"); for (;;) ; } while (0);
  ...
  if ((__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((! handler)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 0)))
    do { g_log ("LibGimpBase", G_LOG_LEVEL_ERROR, "gimp_wire_read_msg: could not find handler for message: %d", msg->type); for (;;) ; } while (0)
                       ;
                     ...
                     gpointer user_data)
{
  ...
  if ((__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((! wire_ht)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 0)))
    do { g_log ("LibGimpBase", G_LOG_LEVEL_ERROR, "gimp_wire_write_msg: the wire protocol has not been initialized"); for (;;) ; } while (0);
  ...
  if ((__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((! handler)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 0)))
    do { g_log ("LibGimpBase", G_LOG_LEVEL_ERROR, "gimp_wire_write_msg: could not find handler for message: %d", msg->type); for (;;) ; } while (0)
                       ;
...
gimp_wire_destroy (GimpWireMessage *msg)
{
  ...
  if ((__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((! wire_ht)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 0)))
    do { g_log ("LibGimpBase", G_LOG_LEVEL_ERROR, "gimp_wire_destroy: the wire protocol has not been initialized"); for (;;) ; } while (0);

  handler = g_hash_table_lookup (wire_ht, &msg->type);

  if ((__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((! handler)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 0)))
    do { g_log ("LibGimpBase", G_LOG_LEVEL_ERROR, "gimp_wire_destroy: could not find handler for message: %d\n", msg->type); for (;;) ; } while (0)
                       ;
  ...
  if (count > 0)
    {
      ...
      while (count--)
        {
          *data = (((((guint32) __builtin_bswap32 ((guint32) (*data))))));
          data++;
        }
    }
  ...
  for (i = 0; i < count; i++)
    {
      ...
      if (tmp > 0)
        {
          data[i] = (gchar *) (__extension__ ({ gsize __n = (gsize) (tmp); gsize __s = sizeof (gchar); gpointer __p; if (__s == 1) __p = g_try_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 435 "/src/gimp-2.6.7/libgimpbase/gimpwire.c" 3 4
                   (0x7fffffffffffffffL * 2UL + 1UL) 
# 435 "/src/gimp-2.6.7/libgimpbase/gimpwire.c"
                   / __s)) __p = g_try_malloc (__n * __s); else __p = g_try_malloc_n (__n, __s); __p; }));
        ...
        {
          data[i] = 
# 455 "/src/gimp-2.6.7/libgimpbase/gimpwire.c" 3 4
                   ((void *)0)
# 455 "/src/gimp-2.6.7/libgimpbase/gimpwire.c"
                       ;
        }
    }
  ...
  if (count > 0)
    {
      ...
      for (i = 0; i < count; i++)
        {
          guint32 tmp = ((((guint32) __builtin_bswap32 ((guint32) (data[i])))));
  ...
  for (i = 0; i < count; i++)
    {
      *t = data[i];
      ...
      if (! _gimp_wire_write_int8 (channel, tmp, 8, user_data))
        return (0);
# 582 "/src/gimp-2.6.7/libgimpbase/gimpwire.c"
    }
