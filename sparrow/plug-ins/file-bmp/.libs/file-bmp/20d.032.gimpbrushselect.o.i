# 1 "/src/gimp-2.6.7/libgimp/gimpbrushselect.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/libgimp/gimpbrushselect.c"
# 22 "/src/gimp-2.6.7/libgimp/gimpbrushselect.c"
# 1 "../config.h" 1
# 23 "/src/gimp-2.6.7/libgimp/gimpbrushselect.c" 2
...
# 25 "/src/gimp-2.6.7/libgimp/gimpbrushselect.c" 2
...
static GHashTable *gimp_brush_select_ht = 
# 58 "/src/gimp-2.6.7/libgimp/gimpbrushselect.c" 3 4
                                         ((void *)0)
# 58 "/src/gimp-2.6.7/libgimp/gimpbrushselect.c"
                                             ;
...
# 94 "/src/gimp-2.6.7/libgimp/gimpbrushselect.c" 3 4
                         ((void *)0)
# 94 "/src/gimp-2.6.7/libgimp/gimpbrushselect.c"
                             ,
                          "",
                          GIMP_TEMPORARY,
                          (sizeof (args) / sizeof ((args)[0])), 0,
                          args, 
# 98 "/src/gimp-2.6.7/libgimp/gimpbrushselect.c" 3 4
                               ((void *)0)
# 98 "/src/gimp-2.6.7/libgimp/gimpbrushselect.c"
                                   ,
                          gimp_temp_brush_run);
  ...
  if (gimp_brushes_popup (brush_callback, title, brush_name,
                          opacity, spacing, paint_mode))
    {
      ...
      brush_data = ((GimpBrushData*) g_slice_alloc0 (sizeof (GimpBrushData)));
  ...
  return 
# 131 "/src/gimp-2.6.7/libgimp/gimpbrushselect.c" 3 4
        ((void *)0)
# 131 "/src/gimp-2.6.7/libgimp/gimpbrushselect.c"
            ;
}
...
gimp_brush_select_destroy (const gchar *brush_callback)
{
  ...
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((brush_callback != 
# 139 "/src/gimp-2.6.7/libgimp/gimpbrushselect.c" 3 4
 ((void *)0)
# 139 "/src/gimp-2.6.7/libgimp/gimpbrushselect.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimp", ((const char*) (__func__)), "brush_callback != NULL"); return; }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((gimp_brush_select_ht != 
# 140 "/src/gimp-2.6.7/libgimp/gimpbrushselect.c" 3 4
 ((void *)0)
# 140 "/src/gimp-2.6.7/libgimp/gimpbrushselect.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimp", ((const char*) (__func__)), "gimp_brush_select_ht != NULL"); return; }; }while (0);

  brush_data = g_hash_table_lookup (gimp_brush_select_ht, brush_callback);

  if (! brush_data)
    {
      g_log ("LibGimp", G_LOG_LEVEL_WARNING, "Can't find internal brush data");
      return;
    }
...
{
  do { if (1) g_slice_free1 (sizeof (GimpBrushData), (data)); else (void) ((GimpBrushData*) 0 == (data)); } while (0);
}
  ...
  if (brush_data->closing)
    {
      ...
      brush_data->brush_callback = 
# 236 "/src/gimp-2.6.7/libgimp/gimpbrushselect.c" 3 4
                                  ((void *)0)
# 236 "/src/gimp-2.6.7/libgimp/gimpbrushselect.c"
                                      ;
