# 1 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
# 13 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
# 1 "../config.h" 1
# 14 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 2
...
# 16 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 2
...
# 17 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 2
...
# 18 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 2
...
# 26 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 2
...
# 27 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 2
...
# 29 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 2
...
_br_find_exe (GimpBinrelocInitError *error)
{
        ...
        return 
# 42 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
              ((void *)0)
# 42 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                  ;
# 168 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
}
...
_br_find_exe_for_symbol (const void *symbol, GimpBinrelocInitError *error)
{
        ...
        if (error)
                *error = GIMP_RELOC_INIT_ERROR_DISABLED;
        return (char *) 
# 181 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                       ((void *)0)
# 181 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                           ;
# 276 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
}


static gchar *exe = 
# 279 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                   ((void *)0)
# 279 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                       ;

static void set_gerror (GError **error, GimpBinrelocInitError errcode);
# 301 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
gboolean
_gimp_reloc_init (GError **error)
{
        ...
        if (exe != 
# 311 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                  ((void *)0)
# 311 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                      )
...
# 334 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
gboolean
_gimp_reloc_init_lib (GError **error)
{
        ...
        if (exe != 
# 343 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                  ((void *)0)
# 343 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                      )
                ...
                set_gerror (error, errcode);
                return exe != 
# 349 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                             ((void *)0)
# 349 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                 ;
        }
}
...
set_gerror (GError **error, GimpBinrelocInitError errcode)
{
        ...
        if (error == 
# 358 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                    ((void *)0)
# 358 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                        )
                return;
...
# 395 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
gchar *
_gimp_reloc_find_exe (const gchar *default_exe)
{
        if (exe == 
# 398 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                  ((void *)0)
# 398 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                      ) {

                if (default_exe != 
# 400 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                                  ((void *)0)
# 400 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                      )
                        return g_strdup (default_exe);
                else
                        return 
# 403 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                              ((void *)0)
# 403 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                  ;
        }
        return g_strdup (exe);
}
# 423 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
gchar *
_gimp_reloc_find_exe_dir (const gchar *default_dir)
{
        if (exe == 
# 426 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                  ((void *)0)
# 426 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                      ) {

                if (default_dir != 
# 428 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                                  ((void *)0)
# 428 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                      )
                        return g_strdup (default_dir);
                else
                        return 
# 431 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                              ((void *)0)
# 431 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                  ;
        }

        return g_path_get_dirname (exe);
}
# 452 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
gchar *
_gimp_reloc_find_prefix (const gchar *default_prefix)
{
        ...
        if (exe == 
# 457 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                  ((void *)0)
# 457 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                      ) {

                if (default_prefix != 
# 459 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                                     ((void *)0)
# 459 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                         )
                        return g_strdup (default_prefix);
                else
                        return 
# 462 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                              ((void *)0)
# 462 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                  ;
        }
...
# 485 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
gchar *
_gimp_reloc_find_bin_dir (const gchar *default_bin_dir)
{
        gchar *prefix, *dir;

        prefix = _gimp_reloc_find_prefix (
# 490 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                                         ((void *)0)
# 490 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                             );
        if (prefix == 
# 491 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                     ((void *)0)
# 491 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                         ) {

                if (default_bin_dir != 
# 493 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                                      ((void *)0)
# 493 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                          )
                        return g_strdup (default_bin_dir);
                else
                        return 
# 496 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                              ((void *)0)
# 496 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                  ;
        }

        dir = g_build_filename (prefix, "bin", 
# 499 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                                              ((void *)0)
# 499 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                                  );
        g_free (prefix);
        return dir;
}
# 519 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
gchar *
_gimp_reloc_find_data_dir (const gchar *default_data_dir)
{
        ...
        prefix = _gimp_reloc_find_prefix (
# 524 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                                         ((void *)0)
# 524 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                             );
        if (prefix == 
# 525 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                     ((void *)0)
# 525 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                         ) {

                if (default_data_dir != 
# 527 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                                       ((void *)0)
# 527 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                           )
                        return g_strdup (default_data_dir);
                else
                        return 
# 530 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                              ((void *)0)
# 530 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                  ;
        }
...
# 536 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                               ((void *)0)
# 536 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                   );
        g_free (prefix);
        return dir;
}
...
_gimp_reloc_find_plugin_dir (const gchar *default_plugin_dir)
{
        ...
        libdir = _gimp_reloc_find_lib_dir (
# 546 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                                          ((void *)0)
# 546 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                              );
        if (libdir == 
# 547 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                     ((void *)0)
# 547 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                         ) {

                if (default_plugin_dir != 
# 549 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                                         ((void *)0)
# 549 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                             )
                        return g_strdup (default_plugin_dir);
                else
                        return 
# 552 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                              ((void *)0)
# 552 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                  ;
        }
...
# 558 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                               ((void *)0)
# 558 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                   );
        g_free (libdir);
        return dir;
}
# 577 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
gchar *
_gimp_reloc_find_locale_dir (const gchar *default_locale_dir)
{
        gchar *data_dir, *dir;

        data_dir = _gimp_reloc_find_data_dir (
# 582 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                                             ((void *)0)
# 582 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                                 );
        if (data_dir == 
# 583 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                       ((void *)0)
# 583 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                           ) {

                if (default_locale_dir != 
# 585 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                                         ((void *)0)
# 585 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                             )
                        return g_strdup (default_locale_dir);
                else
                        return 
# 588 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                              ((void *)0)
# 588 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                  ;
        }

        dir = g_build_filename (data_dir, "locale", 
# 591 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                                                   ((void *)0)
# 591 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                                       );
        g_free (data_dir);
        return dir;
}
# 610 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
gchar *
_gimp_reloc_find_lib_dir (const gchar *default_lib_dir)
{
        ...
        prefix = _gimp_reloc_find_prefix (
# 615 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                                         ((void *)0)
# 615 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                             );
        if (prefix == 
# 616 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                     ((void *)0)
# 616 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                         ) {

                if (default_lib_dir != 
# 618 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                                      ((void *)0)
# 618 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                          )
                        return g_strdup (default_lib_dir);
                else
                        return 
# 621 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                              ((void *)0)
# 621 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                  ;
        }

        dir = g_build_filename (prefix, "lib", 
# 624 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                                              ((void *)0)
# 624 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                                  );
        g_free (prefix);
        return dir;
}
# 643 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
gchar *
_gimp_reloc_find_libexec_dir (const gchar *default_libexec_dir)
{
        ...
        prefix = _gimp_reloc_find_prefix (
# 648 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                                         ((void *)0)
# 648 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                             );
        if (prefix == 
# 649 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                     ((void *)0)
# 649 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                         ) {

                if (default_libexec_dir != 
# 651 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                                          ((void *)0)
# 651 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                              )
                        return g_strdup (default_libexec_dir);
                else
                        return 
# 654 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                              ((void *)0)
# 654 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                  ;
        }

        dir = g_build_filename (prefix, "libexec", 
# 657 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                                                  ((void *)0)
# 657 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                                      );
        g_free (prefix);
        return dir;
}
# 677 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
gchar *
_gimp_reloc_find_etc_dir (const gchar *default_etc_dir)
{
        ...
        prefix = _gimp_reloc_find_prefix (
# 682 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                                         ((void *)0)
# 682 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                             );
        if (prefix == 
# 683 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                     ((void *)0)
# 683 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                         ) {

                if (default_etc_dir != 
# 685 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                                      ((void *)0)
# 685 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                          )
                        return g_strdup (default_etc_dir);
                else
                        return 
# 688 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                              ((void *)0)
# 688 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                  ;
        }
...
# 694 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c" 3 4
                               ((void *)0)
# 694 "/src/gimp-2.6.7/libgimpbase/gimpreloc.c"
                                   );
        g_free (prefix);
        return dir;
}
