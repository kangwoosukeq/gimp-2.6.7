# 1 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c"
# 22 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c"
# 1 "../config.h" 1
# 23 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c" 2
...
# 25 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c" 2
...
static guchar * gimp_pixel_fetcher_provide_tile (GimpPixelFetcher *pf,
                                                 gint x,
                                                 gint y);
# 63 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c"
GimpPixelFetcher *
...
# 72 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c" 3 4
 ((void *)0)
# 72 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimp", ((const char*) (__func__)), "drawable != NULL"); return (
# 72 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c" 3 4
 ((void *)0)
# 72 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c"
 ); }; }while (0);
  ...
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((width > 0 && height > 0 && bpp > 0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimp", ((const char*) (__func__)), "width > 0 && height > 0 && bpp > 0"); return (
# 78 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c" 3 4
 ((void *)0)
# 78 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c"
 ); }; }while (0);

  pf = ((GimpPixelFetcher*) g_slice_alloc0 (sizeof (GimpPixelFetcher)));
  ...
  pf->tile = 
# 99 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c" 3 4
                     ((void *)0)
# 99 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c"
                         ;
  pf->tile_dirty = (0);
  pf->shadow = shadow;
...
{
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((pf != 
# 115 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c" 3 4
 ((void *)0)
# 115 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimp", ((const char*) (__func__)), "pf != NULL"); return; }; }while (0);

  if (pf->tile)
    gimp_tile_unref (pf->tile, pf->tile_dirty);

  do { if (1) g_slice_free1 (sizeof (GimpPixelFetcher), (pf)); else (void) ((GimpPixelFetcher*) 0 == (pf)); } while (0);
}
# 130 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c"
void
gimp_pixel_fetcher_set_edge_mode (GimpPixelFetcher *pf,
                                  GimpPixelFetcherEdgeMode mode)
{
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((pf != 
# 134 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c" 3 4
 ((void *)0)
# 134 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimp", ((const char*) (__func__)), "pf != NULL"); return; }; }while (0);

  pf->mode = mode;
}
# 146 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c"
void
gimp_pixel_fetcher_set_bg_color (GimpPixelFetcher *pf,
                                 const GimpRGB *color)
{
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((pf != 
# 150 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c" 3 4
 ((void *)0)
# 150 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimp", ((const char*) (__func__)), "pf != NULL"); return; }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((color != 
# 151 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c" 3 4
 ((void *)0)
# 151 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimp", ((const char*) (__func__)), "color != NULL"); return; }; }while (0);
...
# 177 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c"
void
                              ...
                              guchar *pixel)
{
  ...
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((pf != 
# 186 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c" 3 4
 ((void *)0)
# 186 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimp", ((const char*) (__func__)), "pf != NULL"); return; }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((pixel != 
# 187 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c" 3 4
 ((void *)0)
# 187 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimp", ((const char*) (__func__)), "pixel != NULL"); return; }; }while (0);
      ...
      y < 0 || y >= pf->img_height)
    {
      switch (pf->mode)
        ...
        case GIMP_PIXEL_FETCHER_EDGE_SMEAR:
          x = (((x) > (pf->img_width - 1)) ? (pf->img_width - 1) : (((x) < (0)) ? (0) : (x)));
          y = (((y) > (pf->img_height - 1)) ? (pf->img_height - 1) : (((y) < (0)) ? (0) : (y)));
          break;
...
# 259 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c"
void
                              ...
                              const guchar *pixel)
{
  ...
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((pf != 
# 268 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c" 3 4
 ((void *)0)
# 268 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimp", ((const char*) (__func__)), "pf != NULL"); return; }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((pixel != 
# 269 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c" 3 4
 ((void *)0)
# 269 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimp", ((const char*) (__func__)), "pixel != NULL"); return; }; }while (0);
                                 ...
                                 gint y)
{
  ...
  if ((col != pf->col) || (row != pf->row) || (pf->tile == 
# 306 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c" 3 4
                                                          ((void *)0)
# 306 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c"
                                                              ))
    {
      if (pf->tile != 
# 308 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c" 3 4
                     ((void *)0)
# 308 "/src/gimp-2.6.7/libgimp/gimppixelfetcher.c"
                         )
        gimp_tile_unref (pf->tile, pf->tile_dirty);
