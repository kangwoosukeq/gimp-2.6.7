# 1 "/src/gimp-2.6.7/libgimpcolor/gimpadaptivesupersample.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/libgimpcolor/gimpadaptivesupersample.c"
# 20 "/src/gimp-2.6.7/libgimpcolor/gimpadaptivesupersample.c"
# 1 "../config.h" 1
# 21 "/src/gimp-2.6.7/libgimpcolor/gimpadaptivesupersample.c" 2
...
# 23 "/src/gimp-2.6.7/libgimpcolor/gimpadaptivesupersample.c" 2
...
# 25 "/src/gimp-2.6.7/libgimpcolor/gimpadaptivesupersample.c" 2
...
# 27 "/src/gimp-2.6.7/libgimpcolor/gimpadaptivesupersample.c" 2

# 1 "/src/gimp-2.6.7/libgimpcolor/gimpadaptivesupersample.h" 1
# 23 "/src/gimp-2.6.7/libgimpcolor/gimpadaptivesupersample.h"
...
# 29 "/src/gimp-2.6.7/libgimpcolor/gimpadaptivesupersample.c" 2
...
# 30 "/src/gimp-2.6.7/libgimpcolor/gimpadaptivesupersample.c" 2
# 42 "/src/gimp-2.6.7/libgimpcolor/gimpadaptivesupersample.c"
                                ...
                                gpointer progress_data)
{
  ...
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((render_func != 
# 256 "/src/gimp-2.6.7/libgimpcolor/gimpadaptivesupersample.c" 3 4
 ((void *)0)
# 256 "/src/gimp-2.6.7/libgimpcolor/gimpadaptivesupersample.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimpColor", ((const char*) (__func__)), "render_func != NULL"); return (0); }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((put_pixel_func != 
# 257 "/src/gimp-2.6.7/libgimpcolor/gimpadaptivesupersample.c" 3 4
 ((void *)0)
# 257 "/src/gimp-2.6.7/libgimpcolor/gimpadaptivesupersample.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimpColor", ((const char*) (__func__)), "put_pixel_func != NULL"); return (0); }; }while (0);
  ...
  top_row = (GimpSampleType *) (__extension__ ({ gsize __n = (gsize) (sub_pixel_size * width + 1); gsize __s = sizeof (GimpSampleType); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 271 "/src/gimp-2.6.7/libgimpcolor/gimpadaptivesupersample.c" 3 4
           (0x7fffffffffffffffL * 2UL + 1UL) 
# 271 "/src/gimp-2.6.7/libgimpcolor/gimpadaptivesupersample.c"
           / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
  bot_row = (GimpSampleType *) (__extension__ ({ gsize __n = (gsize) (sub_pixel_size * width + 1); gsize __s = sizeof (GimpSampleType); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 272 "/src/gimp-2.6.7/libgimpcolor/gimpadaptivesupersample.c" 3 4
           (0x7fffffffffffffffL * 2UL + 1UL) 
# 272 "/src/gimp-2.6.7/libgimpcolor/gimpadaptivesupersample.c"
           / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
  ...
  block = (GimpSampleType * *) (__extension__ ({ gsize __n = (gsize) (sub_pixel_size + 1); gsize __s = sizeof (GimpSampleType *); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 287 "/src/gimp-2.6.7/libgimpcolor/gimpadaptivesupersample.c" 3 4
         (0x7fffffffffffffffL * 2UL + 1UL) 
# 287 "/src/gimp-2.6.7/libgimpcolor/gimpadaptivesupersample.c"
         / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));

  for (y = 0; y < (sub_pixel_size + 1); y++)
    {
      block[y] = (GimpSampleType *) (__extension__ ({ gsize __n = (gsize) (sub_pixel_size + 1); gsize __s = sizeof (GimpSampleType); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 291 "/src/gimp-2.6.7/libgimpcolor/gimpadaptivesupersample.c" 3 4
                (0x7fffffffffffffffL * 2UL + 1UL) 
# 291 "/src/gimp-2.6.7/libgimpcolor/gimpadaptivesupersample.c"
                / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
  ...
  for (y = y1; y <= y2; y++)
    {
      ...
      if (progress_func != 
# 372 "/src/gimp-2.6.7/libgimpcolor/gimpadaptivesupersample.c" 3 4
                          ((void *)0)
# 372 "/src/gimp-2.6.7/libgimpcolor/gimpadaptivesupersample.c"
                              )
