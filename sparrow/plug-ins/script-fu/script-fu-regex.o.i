# 1 "/src/gimp-2.6.7/plug-ins/script-fu/script-fu-regex.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/plug-ins/script-fu/script-fu-regex.c"
# 29 "/src/gimp-2.6.7/plug-ins/script-fu/script-fu-regex.c"
# 1 "../../config.h" 1
# 30 "/src/gimp-2.6.7/plug-ins/script-fu/script-fu-regex.c" 2
...
int is_immutable(pointer p);
void setimmutable(pointer p);
# 32 "/src/gimp-2.6.7/plug-ins/script-fu/script-fu-regex.c" 2
# 1 "/src/gimp-2.6.7/plug-ins/script-fu/script-fu-regex.h" 1
# 23 "/src/gimp-2.6.7/plug-ins/script-fu/script-fu-regex.h"
void script_fu_regex_init (scheme *sc);
# 33 "/src/gimp-2.6.7/plug-ins/script-fu/script-fu-regex.c" 2
...
# 72 "/src/gimp-2.6.7/plug-ins/script-fu/script-fu-regex.c"
}
                  ...
                  pointer args)
{
  ...
  regex = g_regex_new (pattern, G_REGEX_EXTENDED, 0, 
# 117 "/src/gimp-2.6.7/plug-ins/script-fu/script-fu-regex.c" 3 4
                                                    ((void *)0)
# 117 "/src/gimp-2.6.7/plug-ins/script-fu/script-fu-regex.c"
                                                        );
  if (! regex)
    return sc->F;
  ...
  if (! num)
    {
      success = g_regex_match (regex, string, 0, 
# 123 "/src/gimp-2.6.7/plug-ins/script-fu/script-fu-regex.c" 3 4
                                                ((void *)0)
# 123 "/src/gimp-2.6.7/plug-ins/script-fu/script-fu-regex.c"
                                                    );
    }
  else
    {
