# 1 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c"
# 22 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c"
# 1 "../../config.h" 1
# 23 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c" 2
...
# 25 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c" 2
...
# 27 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c" 2
...
# 29 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c" 2

# 1 "/src/gimp-2.6.7/app/core/gimpcontainer.h" 1
# 26 "/src/gimp-2.6.7/app/core/gimpcontainer.h"
...
gint64 gimp_object_get_memsize (GimpObject *object,
                                           gint64 *gui_size);
# 27 "/src/gimp-2.6.7/app/core/gimpcontainer.h" 2
...
void gimp_container_remove_handler (GimpContainer *container,
                                                GQuark id);
# 31 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c" 2
# 1 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.h" 1
# 26 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.h"
...
gchar ** gimp_container_get_filtered_name_array
                                              (const GimpContainer *container,
                                               const gchar *regexp,
                                               gint *length);
# 32 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c" 2
# 1 "/src/gimp-2.6.7/app/core/gimplist.h" 1
# 37 "/src/gimp-2.6.7/app/core/gimplist.h"
...
# 33 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c" 2
...
# 62 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c"
GimpContainer *
...
# 70 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c" 3 4
 ((void *)0)
# 70 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c"
 ); }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((filter != 
# 71 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c" 3 4
 ((void *)0)
# 71 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "filter != NULL"); return (
# 71 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c" 3 4
 ((void *)0)
# 71 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c"
 ); }; }while (0);
...
# 77 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c" 3 4
                 ((void *)0)
# 77 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c"
                     );
...
gimp_object_filter_by_name (const GimpObject *object,
                            const GRegex *regex)
{
  return g_regex_match (regex, gimp_object_get_name (object), 0, 
# 100 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c" 3 4
                                                                ((void *)0)
# 100 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c"
                                                                    );
}
# 114 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c"
GimpContainer *
                               ...
                               GError **error)
{
  ...
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((container)); GType __t = ((gimp_container_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_CONTAINER (container)"); return (
# 122 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c" 3 4
 ((void *)0)
# 122 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c"
 ); }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((regexp != 
# 123 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c" 3 4
 ((void *)0)
# 123 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "regexp != NULL"); return (
# 123 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c" 3 4
 ((void *)0)
# 123 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c"
 ); }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((error == 
# 124 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c" 3 4
 ((void *)0) 
# 124 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c"
 || *error == 
# 124 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c" 3 4
 ((void *)0)
# 124 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "error == NULL || *error == NULL"); return (
# 124 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c" 3 4
 ((void *)0)
# 124 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c"
 ); }; }while (0);
  ...
  if (! regex)
    return 
# 130 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c" 3 4
          ((void *)0)
# 130 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c"
              ;
                                        ...
                                        gint *length)
{
  GimpContainer *weak;
  GError *error = 
# 149 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c" 3 4
                        ((void *)0)
# 149 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c"
                            ;

  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((container)); GType __t = ((gimp_container_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_CONTAINER (container)"); return (
# 151 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c" 3 4
 ((void *)0)
# 151 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c"
 ); }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((length != 
# 152 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c" 3 4
 ((void *)0)
# 152 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c"
...
# 152 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c"
  ...
  if (regexp == 
# 154 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c" 3 4
               ((void *)0) 
# 154 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c"
                    || strlen (regexp) == 0)
  ...
  if (weak)
    ...
    {
      g_log ("Gimp-Core", G_LOG_LEVEL_WARNING, error->message);
      g_error_free (error);

      *length = 0;
      return 
# 173 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c" 3 4
            ((void *)0)
# 173 "/src/gimp-2.6.7/app/core/gimpcontainer-filter.c"
                ;
    }
}
