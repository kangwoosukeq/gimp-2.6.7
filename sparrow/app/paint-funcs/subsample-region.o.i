# 1 "/src/gimp-2.6.7/app/paint-funcs/subsample-region.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/app/paint-funcs/subsample-region.c"
# 19 "/src/gimp-2.6.7/app/paint-funcs/subsample-region.c"
# 1 "../../config.h" 1
# 20 "/src/gimp-2.6.7/app/paint-funcs/subsample-region.c" 2
...
# 22 "/src/gimp-2.6.7/app/paint-funcs/subsample-region.c" 2
...
# 24 "/src/gimp-2.6.7/app/paint-funcs/subsample-region.c" 2
...
# 26 "/src/gimp-2.6.7/app/paint-funcs/subsample-region.c" 2
...
# 28 "/src/gimp-2.6.7/app/paint-funcs/subsample-region.c" 2

# 1 "/src/gimp-2.6.7/app/paint-funcs/subsample-region.h" 1
# 23 "/src/gimp-2.6.7/app/paint-funcs/subsample-region.h"
...
void subsample_indexed_region (PixelRegion *srcPR,
                                 ...
                                 const guchar *cmap,
                                 gint subsample);
# 30 "/src/gimp-2.6.7/app/paint-funcs/subsample-region.c" 2
                  ...
                  gint subsample)
{
  ...
  src = (guchar *) (__extension__ ({ gsize __n = (gsize) (orig_width * bytes); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 68 "/src/gimp-2.6.7/app/paint-funcs/subsample-region.c" 3 4
        (0x7fffffffffffffffL * 2UL + 1UL) 
# 68 "/src/gimp-2.6.7/app/paint-funcs/subsample-region.c"
        / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
  dest = destPR->data;


  row = (gdouble *) (__extension__ ({ gsize __n = (gsize) (width * bytes); gsize __s = sizeof (gdouble); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 72 "/src/gimp-2.6.7/app/paint-funcs/subsample-region.c" 3 4
          (0x7fffffffffffffffL * 2UL + 1UL) 
# 72 "/src/gimp-2.6.7/app/paint-funcs/subsample-region.c"
          / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
  x_frac = (gdouble *) (__extension__ ({ gsize __n = (gsize) (width + orig_width); gsize __s = sizeof (gdouble); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 73 "/src/gimp-2.6.7/app/paint-funcs/subsample-region.c" 3 4
          (0x7fffffffffffffffL * 2UL + 1UL) 
# 73 "/src/gimp-2.6.7/app/paint-funcs/subsample-region.c"
          / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
                          ...
                          gint subsample)
{
  ...
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((cmap != 
# 266 "/src/gimp-2.6.7/app/paint-funcs/subsample-region.c" 3 4
 ((void *)0)
# 266 "/src/gimp-2.6.7/app/paint-funcs/subsample-region.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Paint-Funcs", ((const char*) (__func__)), "cmap != NULL"); return; }; }while (0);


  src = (guchar *) (__extension__ ({ gsize __n = (gsize) (orig_width * bytes); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 269 "/src/gimp-2.6.7/app/paint-funcs/subsample-region.c" 3 4
        (0x7fffffffffffffffL * 2UL + 1UL) 
# 269 "/src/gimp-2.6.7/app/paint-funcs/subsample-region.c"
        / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
  dest = destPR->data;


  row = (gdouble *) (__extension__ ({ gsize __n = (gsize) (width * bytes); gsize __s = sizeof (gdouble); gpointer __p; if (__s == 1) __p = g_malloc0 (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 273 "/src/gimp-2.6.7/app/paint-funcs/subsample-region.c" 3 4
          (0x7fffffffffffffffL * 2UL + 1UL) 
# 273 "/src/gimp-2.6.7/app/paint-funcs/subsample-region.c"
          / __s)) __p = g_malloc0 (__n * __s); else __p = g_malloc0_n (__n, __s); __p; }));
  x_frac = (gdouble *) (__extension__ ({ gsize __n = (gsize) (width + orig_width); gsize __s = sizeof (gdouble); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 274 "/src/gimp-2.6.7/app/paint-funcs/subsample-region.c" 3 4
          (0x7fffffffffffffffL * 2UL + 1UL) 
# 274 "/src/gimp-2.6.7/app/paint-funcs/subsample-region.c"
          / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
