# 1 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
# 1 "/src/gimp-2.6.7/app/paint-funcs//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
# 19 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
# 1 "../../config.h" 1
# 20 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 2
...
# 22 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 2
...
# 24 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 2
...
# 26 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 2
...
# 27 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 2

# 1 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs-types.h" 1
# 23 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs-types.h"
# 1 "../../app/base/base-types.h" 1
# 23 "../../app/base/base-types.h"
# 1 "../../libgimpbase/gimpbasetypes.h" 1
# 27 "../../libgimpbase/gimpbasetypes.h"
...
# 27 "../../app/config/config-types.h" 2
...
# 24 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs-types.h" 2
# 36 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs-types.h"
typedef enum
{
...
# 29 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 2

# 1 "../../app/base/pixel-processor.h" 1
# 28 "../../app/base/pixel-processor.h"
...
void pixel_regions_process_parallel_progress
                                      (PixelProcessorFunc func,
                                       ...
                                       gint num_regions,
                                       ...);
# 31 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 2
# 1 "../../app/base/pixel-region.h" 1
# 23 "../../app/base/pixel-region.h"
struct _PixelRegion
{
  guchar *data;
  TileManager *tiles;
...
# 32 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 2
# 1 "../../app/base/temp-buf.h" 1
# 23 "../../app/base/temp-buf.h"
struct _TempBuf
{
  gint bytes;
  gint width;
...
# 33 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 2
# 1 "../../app/base/tile-manager.h" 1
# 26 "../../app/base/tile-manager.h"
...
void write_pixel_data_1 (TileManager *tm,
                                      ...
                                      gint y,
                                      const guchar *buffer);
# 34 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 2
# 1 "../../app/base/tile-rowhints.h" 1
# 28 "../../app/base/tile-rowhints.h"
typedef guchar TileRowHint;
# 38 "../../app/base/tile-rowhints.h"
...
void tile_update_rowhints (Tile *tile,
                                      gint start,
                                      gint rows);
# 35 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 2
# 1 "../../app/base/tile.h" 1
# 29 "../../app/base/tile.h"
...
void tile_detach (Tile *tile,
                                  void *tm,
                                  gint tile_num);
# 36 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 2

# 1 "../../app/composite/gimp-composite.h" 1
# 25 "../../app/composite/gimp-composite.h"
typedef enum
{
  GIMP_PIXELFORMAT_V8,
...
# 54 "../../app/composite/gimp-composite.h"
...
# 74 "../../app/composite/gimp-composite.h"
typedef enum
{
...
# 38 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 2

# 1 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.h" 1
# 24 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.h"
...
void combine_regions_replace (PixelRegion *src1,
                                           ...
                                           const gboolean *affect,
                                           CombinationMode type);
# 40 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 2
# 1 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs-generic.h" 1
# 53 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs-generic.h"
              ...
              guint bytes)
{
  switch (bytes)
    ...
    case 2:
# 97 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs-generic.h"
      {
    ...
    case 4:
# 144 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs-generic.h"
      {
...
# 255 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs-generic.h"
  for (i = 0; i < w; i++)
    {
...
# 286 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs-generic.h"
inline void
               ...
               guint bytes2)
{
  ...
  const guint alpha = ((has_alpha1 || has_alpha2) ?
                            (((bytes1) > (bytes2)) ? (bytes1) : (bytes2)) - 1 : bytes1);
      ...
      for (b = 0; b < alpha; b++)
        {
          ...
          dest[b] = (guchar) (((255 - tmp) > (255)) ? (255) : (((255 - tmp) < (0)) ? (0) : (255 - tmp)));
        }
  ...
  while (length --)
    {
      guint b;
        ...
        for (b = 0; b < alpha; b++)
        {
         ...
         guint tmpM = ((tmpM) = (src1[b]) * (src2[b]) + 0x80, ((((tmpM) >> 8) + (tmpM)) >> 8));
         guint tmpS = 255 - ((tmp1) = ((255 - src1[b])) * ((255 - src2[b])) + 0x80, ((((tmp1) >> 8) + (tmp1)) >> 8));

          dest[b] = ((tmp2) = ((255 - src1[b])) * (tmpM) + 0x80, ((((tmp2) >> 8) + (tmp2)) >> 8)) +
            ((tmp3) = (src1[b]) * (tmpS) + 0x80, ((((tmp3) >> 8) + (tmp3)) >> 8));
        }
  ...
  while (length--)
    {
      ...
      dest[alpha] = (rand_val >= combined_opacity) ? 0 : 255;
                ...
                gint bytes2)
{
  ...
  if (bytes1 != bytes2)
    {
      g_log ("Gimp-Paint-Funcs", G_LOG_LEVEL_WARNING, "replace_pixels only works on commensurate pixel regions");
      return;
    }
...
{
  const guint has_alpha1 = (~alms->bytes1 & 1);
  const guint has_alpha2 = (~alms->bytes2 & 1);
  guint dest_bytes;
...
layer_erase_mode (struct apply_layer_mode_struct *alms)
{
  *(alms->dest) = alms->src2;
  ...
  alms->combine =
    ((~alms->bytes1 & 1) && (~alms->bytes2 & 1)) ? ERASE_INTEN : 0;
}
...
layer_anti_erase_mode (struct apply_layer_mode_struct *alms)
{
  *(alms->dest) = alms->src2;
  alms->combine =
    ((~alms->bytes1 & 1) && (~alms->bytes2 & 1)) ? ANTI_ERASE_INTEN : 0;
}
...
layer_color_erase_mode (struct apply_layer_mode_struct *alms)
{
  *(alms->dest) = alms->src2;
  alms->combine =
    ((~alms->bytes1 & 1) && (~alms->bytes2 & 1)) ? COLOR_ERASE_INTEN : 0;
}
...
# 41 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 2
# 50 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
            ...
            gint *length)
{
  ...
  curve = (gint *) (__extension__ ({ gsize __n = (gsize) (n); gsize __s = sizeof (gint); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 172 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
         (0x7fffffffffffffffL * 2UL + 1UL) 
# 172 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
...
# 743 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
void
...
# 1396 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
static inline void
  ...
  while (length --)
    {
      switch (bytes)
        ...
        case 2:
          ...
          gimp_rgba_get_uchar (&color, dest, 
# 1765 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
                                            ((void *)0)
# 1765 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                                                , 
# 1765 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
                                                  ((void *)0)
# 1765 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
...
clear_region (PixelRegion *dest)
{
  ...
  for (pr = pixel_regions_register (1, dest);
       pr != 
# 1894 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
            ((void *)0)
# 1894 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                ;
              ...
              const guchar *col)
{
  ...
  for (pr = pixel_regions_register (1, dest);
       pr != 
# 1924 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
            ((void *)0)
# 1924 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                ;
       pr = pixel_regions_process (pr))
    {
      guchar *s = dest->data;
                  ...
                  const guchar *col)
{
  ...
  for (pr = pixel_regions_register (2, dest, mask);
       pr != 
# 1958 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
            ((void *)0)
# 1958 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                ;
       pr = pixel_regions_process (pr))
    {
      guchar *d = dest->data;
                ...
                gint off_y)
{
  ...
  for (pr = pixel_regions_register (2, dest, mask);
       pr != 
# 1997 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
            ((void *)0)
# 1997 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                ;
       pr = pixel_regions_process (pr))
    {
      guchar *d = dest->data;
      const guchar *m = mask ? mask->data : 
# 2001 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
                                           ((void *)0)
# 2001 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                                               ;
      gint y;
              ...
              guchar blend)
{
  ...
  for (pr = pixel_regions_register (3, src1, src2, dest);
       pr != 
# 2027 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
            ((void *)0)
# 2027 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                ;
       pr = pixel_regions_process (pr))
    {
             ...
             PixelRegion *dest)
{
  ...
  for (pr = pixel_regions_register (2, src, dest);
       pr != 
# 2077 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
            ((void *)0)
# 2077 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                ;
       pr = pixel_regions_process (pr))
    {
                   ...
                   PixelRegion *dest)
{
  ...
  for (pr = pixel_regions_register (2, src, dest);
       pr != 
# 2129 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
            ((void *)0)
# 2129 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                ;
       pr = pixel_regions_process (pr))
    {
      const guchar *s = src->data;
                  ...
                  PixelRegion *dest)
{
  ...
  for (pr = pixel_regions_register (2, src, dest);
       pr != 
# 2155 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
            ((void *)0)
# 2155 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                ;
       pr = pixel_regions_process (pr))
    {
      const guchar *s = src->data;
                ...
                guchar *bg)
{
  ...
  for (pr = pixel_regions_register (2, src, dest);
       pr != 
# 2181 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
            ((void *)0)
# 2181 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                ;
       pr = pixel_regions_process (pr))
    {
      const guchar *s = src->data;
                      ...
                      PixelRegion *dest)
{
  ...
  for (pr = pixel_regions_register (3, src, mask, dest);
       pr != 
# 2206 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
            ((void *)0)
# 2206 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                ;
       pr = pixel_regions_process (pr))
    {
      const guchar *m = mask ? mask->data : 
# 2209 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
                                           ((void *)0)
# 2209 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                                               ;
      const guchar *s = src->data;
      guchar *d = dest->data;
      gint h = src->h;
                     ...
                     gboolean cut)
{
  ...
  for (pr = pixel_regions_register (3, src, dest, mask);
       pr != 
# 2239 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
            ((void *)0)
# 2239 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                ;
       pr = pixel_regions_process (pr))
    {
      const guchar *m = mask ? mask->data : 
# 2242 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
                                           ((void *)0)
# 2242 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                                               ;
      guchar *s = src->data;
      guchar *d = dest->data;
      gint h = src->h;
                      ...
                      gdouble radius_y)
{
  ...
  data = (guchar *) (__extension__ ({ gsize __n = (gsize) (length * 2); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 2514 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
        (0x7fffffffffffffffL * 2UL + 1UL) 
# 2514 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
        / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
  src = data;
  dest = data + length;
  ...
  buf = (guint *) (__extension__ ({ gsize __n = (gsize) ((((width) > (height)) ? (width) : (height)) * 2); gsize __s = sizeof (guint); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 2523 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
       (0x7fffffffffffffffL * 2UL + 1UL) 
# 2523 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
       / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
  ...
  if (radius_y != 0.0)
    {
      ...
      sum = (gint *) (__extension__ ({ gsize __n = (gsize) (2 * length + 1); gsize __s = sizeof (gint); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 2529 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
           (0x7fffffffffffffffL * 2UL + 1UL) 
# 2529 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
           / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
      sum[0] = 0;
  ...
  if (radius_x != 0.0)
    {
      ...
      sum = (gint *) (__extension__ ({ gsize __n = (gsize) (2 * length + 1); gsize __s = sizeof (gint); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 2590 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
           (0x7fffffffffffffffL * 2UL + 1UL) 
# 2590 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
           / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
      sum[0] = 0;
                   ...
                   gpointer progress_data)
{
  ...
  length = distPR->w + 1;
  memory = (gfloat *) (__extension__ ({ gsize __n = (gsize) (length * 2); gsize __s = sizeof (gfloat); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 2703 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
          (0x7fffffffffffffffL * 2UL + 1UL) 
# 2703 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
          / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
               ...
               gint16 yradius)
{
  ...
  max = (guchar * *) (__extension__ ({ gsize __n = (gsize) (region->w + 2 * xradius); gsize __s = sizeof (guchar *); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 2863 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
       (0x7fffffffffffffffL * 2UL + 1UL) 
# 2863 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
       / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
  buf = (guchar * *) (__extension__ ({ gsize __n = (gsize) (yradius + 1); gsize __s = sizeof (guchar *); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 2864 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
       (0x7fffffffffffffffL * 2UL + 1UL) 
# 2864 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
       / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));

  for (i = 0; i < yradius + 1; i++)
    buf[i] = (guchar *) (__extension__ ({ gsize __n = (gsize) (region->w); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 2867 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
            (0x7fffffffffffffffL * 2UL + 1UL) 
# 2867 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
            / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));

  buffer = (guchar *) (__extension__ ({ gsize __n = (gsize) ((region->w + 2 * xradius) * (yradius + 1)); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 2869 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
          (0x7fffffffffffffffL * 2UL + 1UL) 
# 2869 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
          / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
  ...
  out = (guchar *) (__extension__ ({ gsize __n = (gsize) (region->w); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 2888 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
        (0x7fffffffffffffffL * 2UL + 1UL) 
# 2888 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
        / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));

  circ = (gint16 *) (__extension__ ({ gsize __n = (gsize) (2 * xradius + 1); gsize __s = sizeof (gint16); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 2890 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
        (0x7fffffffffffffffL * 2UL + 1UL) 
# 2890 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
        / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
...
thin_region (PixelRegion *region,
             ...
             gboolean edge_lock)
{
# 3006 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
  register gint32 i, j, x, y;
  guchar **buf;
  guchar *out;
  guchar **max;
  ...
  max = (guchar * *) (__extension__ ({ gsize __n = (gsize) (region->w + 2 * xradius); gsize __s = sizeof (guchar *); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 3019 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
       (0x7fffffffffffffffL * 2UL + 1UL) 
# 3019 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
       / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
  buf = (guchar * *) (__extension__ ({ gsize __n = (gsize) (yradius + 1); gsize __s = sizeof (guchar *); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 3020 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
       (0x7fffffffffffffffL * 2UL + 1UL) 
# 3020 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
       / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));

  for (i = 0; i < yradius + 1; i++)
    buf[i] = (guchar *) (__extension__ ({ gsize __n = (gsize) (region->w); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 3023 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
            (0x7fffffffffffffffL * 2UL + 1UL) 
# 3023 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
            / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));

  buffer_size = (region->w + 2 * xradius + 1) * (yradius + 1);
  buffer = (guchar *) (__extension__ ({ gsize __n = (gsize) (buffer_size); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 3026 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
          (0x7fffffffffffffffL * 2UL + 1UL) 
# 3026 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
          / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
  ...
  out = (guchar *) (__extension__ ({ gsize __n = (gsize) (region->w); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 3063 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
       (0x7fffffffffffffffL * 2UL + 1UL) 
# 3063 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
       / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));

  circ = (gint16 *) (__extension__ ({ gsize __n = (gsize) (2 * xradius + 1); gsize __s = sizeof (gint16); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 3065 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
        (0x7fffffffffffffffL * 2UL + 1UL) 
# 3065 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
        / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
  compute_border (circ, xradius, yradius);
...
smooth_region (PixelRegion *region)
{
  ...
  for (i = 0; i < 3; i++)
    buf[i] = (guchar *) (__extension__ ({ gsize __n = (gsize) (width + 2); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 3185 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
            (0x7fffffffffffffffL * 2UL + 1UL) 
# 3185 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
            / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));

  out = (guchar *) (__extension__ ({ gsize __n = (gsize) (width); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 3187 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
       (0x7fffffffffffffffL * 2UL + 1UL) 
# 3187 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
       / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
...
erode_region (PixelRegion *region)
{
  ...
  for (i = 0; i < 3; i++)
    buf[i] = (guchar *) (__extension__ ({ gsize __n = (gsize) (width + 2); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 3245 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
            (0x7fffffffffffffffL * 2UL + 1UL) 
# 3245 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
            / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));

  out = (guchar *) (__extension__ ({ gsize __n = (gsize) (width); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 3247 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
       (0x7fffffffffffffffL * 2UL + 1UL) 
# 3247 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
       / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
...
dilate_region (PixelRegion *region)
{
  ...
  for (i = 0; i < 3; i++)
    buf[i] = (guchar *) (__extension__ ({ gsize __n = (gsize) (width + 2); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 3309 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
            (0x7fffffffffffffffL * 2UL + 1UL) 
# 3309 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
            / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));

  out = (guchar *) (__extension__ ({ gsize __n = (gsize) (width); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 3311 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
       (0x7fffffffffffffffL * 2UL + 1UL) 
# 3311 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
       / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
               ...
               gboolean edge_lock)
{
  ...
  if (xradius < 0 || yradius < 0)
    {
      g_log ("Gimp-Paint-Funcs", G_LOG_LEVEL_WARNING, "border_region: negative radius specified.");
      return;
    }
  ...
  if (xradius == 1 && yradius == 1)
    {
      ...
      for (i = 0; i < 3; i++)
        source[i] = (guchar *) (__extension__ ({ gsize __n = (gsize) (src->w); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 3511 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
                   (0x7fffffffffffffffL * 2UL + 1UL) 
# 3511 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                   / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));

      transition = (guchar *) (__extension__ ({ gsize __n = (gsize) (src->w); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 3513 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
                  (0x7fffffffffffffffL * 2UL + 1UL) 
# 3513 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                  / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
  ...
  max = (gint16 *) (__extension__ ({ gsize __n = (gsize) (src->w + 2 * xradius); gsize __s = sizeof (gint16); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 3558 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
       (0x7fffffffffffffffL * 2UL + 1UL) 
# 3558 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
       / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
  ...
  for (i = 0; i < 3; i++)
    buf[i] = (guchar *) (__extension__ ({ gsize __n = (gsize) (src->w); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 3566 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
            (0x7fffffffffffffffL * 2UL + 1UL) 
# 3566 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
            / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));

  transition = (guchar * *) (__extension__ ({ gsize __n = (gsize) (yradius + 1); gsize __s = sizeof (guchar *); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 3568 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
              (0x7fffffffffffffffL * 2UL + 1UL) 
# 3568 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
              / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));

  for (i = 0; i < yradius + 1; i++)
    {
      transition[i] = (guchar *) (__extension__ ({ gsize __n = (gsize) (src->w + 2 * xradius); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 3572 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
                     (0x7fffffffffffffffL * 2UL + 1UL) 
# 3572 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                     / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
      memset(transition[i], 0, src->w + 2 * xradius);
      transition[i] += xradius;
    }

  out = (guchar *) (__extension__ ({ gsize __n = (gsize) (src->w); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 3577 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
       (0x7fffffffffffffffL * 2UL + 1UL) 
# 3577 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
       / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));

  density = (guchar * *) (__extension__ ({ gsize __n = (gsize) (2 * xradius + 1); gsize __s = sizeof (guchar *); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 3579 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
           (0x7fffffffffffffffL * 2UL + 1UL) 
# 3579 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
           / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
  density += xradius;
  ...
  for (x = 0; x < (xradius + 1); x++)
    {
      density[ x] = (guchar *) (__extension__ ({ gsize __n = (gsize) (2 * yradius + 1); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 3585 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
                    (0x7fffffffffffffffL * 2UL + 1UL) 
# 3585 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                    / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
      density[ x] += yradius;
      density[-x] = density[x];
    }
             ...
             PixelRegion *dest)
{
  ...
  for (pr = pixel_regions_register (2, src, dest);
       pr != 
# 3820 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
            ((void *)0)
# 3820 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                ;
       pr = pixel_regions_process (pr))
    {
      guchar *s = src->data;
                     ...
                     PixelRegion *dest)
{
  ...
  for (pr = pixel_regions_register (2, src, dest);
       pr != 
# 3933 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
            ((void *)0)
# 3933 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                ;
       pr = pixel_regions_process (pr))
    {
      const guchar *s = src->data;
                ...
                guint pixel)
{
  ...
  for (pr = pixel_regions_register (2, src, dest);
       pr != 
# 3958 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
            ((void *)0)
# 3958 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                ;
       pr = pixel_regions_process (pr))
    {
      const guchar *s = src->data;
            ...
            PixelRegion *dest)
{
  ...
  for (pr = pixel_regions_register (2, src, dest);
       pr != 
# 3981 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
            ((void *)0)
# 3981 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                ;
       pr = pixel_regions_process (pr))
    {
      const guchar *s = src->data;
                    ...
                    PixelRegion *mask)
{
  ...
  buf = 
# 4022 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
       __builtin_alloca (
# 4022 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
       (((src->w * (src->bytes + 1)) > (dest->w * dest->bytes)) ? (src->w * (src->bytes + 1)) : (dest->w * dest->bytes))
# 4022 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
       )
                                              
# 4023 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                                             ;
  data = st->data;
  opacity = st->opacity;
  mode = st->mode;
  ...
  d = dest->data;
  m = mask ? mask->data : 
# 4032 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
                         ((void *)0)
# 4032 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                             ;
      ...
      switch (type)
        ...
        case INITIAL_INTENSITY:
          if (mode == GIMP_DISSOLVE_MODE)
            {
              if (gimp_composite_options.bits & 0x1)
                {
                  GimpCompositeContext ctx;

                  ctx.A = 
# 4059 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
                         ((void *)0)
# 4059 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                             ;
              ...
              initial_inten_a_pixels (buf, d, 
# 4088 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
                                             ((void *)0)
# 4088 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                                                 , 255, affect,
                                      src->w, src->bytes + 1);
            }
          else
              ...
              if (gimp_composite_options.bits & 0x1)
                {
                  ...
                  ctx.A = 
# 4105 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
                         ((void *)0)
# 4105 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                             ;
                  ctx.pixelformat_A = GIMP_PIXELFORMAT_RGBA8;
              ...
              initial_inten_a_pixels (buf, d, 
# 4134 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
                                             ((void *)0)
# 4134 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                                                 , 255, affect,
                                      src->w, src->bytes);
            }
          else
                    ...
                    PixelRegion *mask)
{
  ...
  buf = 
# 4249 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
       __builtin_alloca (
# 4249 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
       ((((((src1->w * src1->bytes) > (src2->w * (src2->bytes + 1))) ? (src1->w * src1->bytes) : (src2->w * (src2->bytes + 1)))) > (dest->w * dest->bytes)) ? ((((src1->w * src1->bytes) > (src2->w * (src2->bytes + 1))) ? (src1->w * src1->bytes) : (src2->w * (src2->bytes + 1)))) : (dest->w * dest->bytes))
# 4249 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
       )

                                              
# 4251 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                                             ;
  ...
  d = dest->data;
  m = mask ? mask->data : 
# 4267 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
                         ((void *)0)
# 4267 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                             ;
  ...
  if (mode == GIMP_DISSOLVE_MODE)
    {
      opacity = 255;
      m = 
# 4291 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
               ((void *)0)
# 4291 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                   ;
    }
  ...
  for (h = 0; h < src1->h; h++)
    {
      ...
      switch (type)
        ...
        default:
          g_log ("Gimp-Paint-Funcs", G_LOG_LEVEL_WARNING, "combine_sub_region: unhandled combine-type.");
          break;
        }
      ...
      switch (combine)
        ...
        case NO_COMBINATION:
          g_log ("Gimp-Paint-Funcs", G_LOG_LEVEL_WARNING, "NO_COMBINATION");
          break;

        default:
          g_log ("Gimp-Paint-Funcs", G_LOG_LEVEL_WARNING, "UNKNOWN COMBINATION: %d", combine);
          break;
        }
                 ...
                 CombinationMode type)
{
  ...
  st.type = type;
  st.data = data;
# 4629 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                         ...
                         CombinationMode type)
{
  ...
  for (pr = pixel_regions_register (4, src1, src2, dest, mask);
       pr != 
# 4677 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c" 3 4
            ((void *)0)
# 4677 "/src/gimp-2.6.7/app/paint-funcs/paint-funcs.c"
                ;
       pr = pixel_regions_process (pr))
    {
      const guchar *s1 = src1->data;
