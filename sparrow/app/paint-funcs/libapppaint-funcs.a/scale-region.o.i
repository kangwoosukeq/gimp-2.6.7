# 1 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c"
# 19 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c"
# 1 "../../config.h" 1
# 20 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 2
...
# 22 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 2
...
# 24 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 2
...
# 26 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 2
...
# 28 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 2
...
void tile_detach (Tile *tile,
                                  void *tm,
                                  gint tile_num);
# 30 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 2
...
void write_pixel_data_1 (TileManager *tm,
                                      ...
                                      gint y,
                                      const guchar *buffer);
# 31 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 2
...
# 32 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 2
# 1 "../../app/base/pixel-surround.h" 1
# 27 "../../app/base/pixel-surround.h"
typedef enum
{
...
# 33 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 2
...
void combine_regions_replace (PixelRegion *src1,
                                           ...
                                           const gboolean *affect,
                                           CombinationMode type);
# 35 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 2
# 1 "/src/gimp-2.6.7/app/paint-funcs/scale-region.h" 1
# 30 "/src/gimp-2.6.7/app/paint-funcs/scale-region.h"
...
# 36 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 2
...
void gimp_logv (const gchar *function,
                      ...
                      const gchar *format,
                      va_list args);
# 38 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 2
              ...
              gpointer progress_data)
{
  ...
  if (srcPR->tiles == 
# 181 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 3 4
                     ((void *)0) 
# 181 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c"
                          && srcPR->data != 
# 181 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 3 4
                                            ((void *)0)
# 181 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c"
    ...
    {
      do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((interpolation == GIMP_INTERPOLATION_LINEAR)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Paint-Funcs", ((const char*) (__func__)), "interpolation == GIMP_INTERPOLATION_LINEAR"); return; }; }while (0);
      do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((progress_callback == 
# 184 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 3 4
     ((void *)0)
# 184 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c"
     )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Paint-Funcs", ((const char*) (__func__)), "progress_callback == NULL"); return; }; }while (0);
  ...
  if (srcPR->tiles != 
# 190 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 3 4
                     ((void *)0) 
# 190 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c"
                          && srcPR->data == 
# 190 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 3 4
                                            ((void *)0)
# 190 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c"
  ...
  do { g_assertion_message_expr ("Gimp-Paint-Funcs", "/src/gimp-2.6.7/app/paint-funcs/scale-region.c", 197, ((const char*) (__func__)), 
# 197 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 3 4
 ((void *)0)
# 197 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c"
 ); } while (0);
}
...
{
  TileManager *tmpTM = 
# 308 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 3 4
                             ((void *)0)
# 308 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c"
                                 ;
  ...
  if (tmpTM != 
# 427 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 3 4
              ((void *)0)
# 427 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c"
                  )
    {
...
# 450 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 3 4
                              ((void *)0)
# 450 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c"
                                  ;
...
# 459 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 3 4
                                 ((void *)0)
# 459 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c"
                                     ;

  do { if (gimp_log_flags & GIMP_LOG_SCALE) gimp_log (((const char*) (__func__)),
 462
# 461 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c"
  , "SCALE", "scale: %dx%d -> %dx%d", src_width, src_height, dst_width, dst_height); } while (0)
                                                         ;
  ...
  for (pr = pixel_regions_register (1, &region);
       pr != 
# 501 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 3 4
            ((void *)0)
# 501 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c"
                ;
             ...
             gint max_progress)
{
  PixelRegion region;
  PixelSurround *surround = 
# 580 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 3 4
                              ((void *)0)
# 580 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c"
                                  ;
  const guint bytes = tile_manager_bpp (dstTM);
  const guint dst_width = tile_manager_width (dstTM);
  const guint dst_height = tile_manager_height (dstTM);
...
# 586 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c"
  ...
  for (pr = pixel_regions_register (1, &region);
       pr != 
# 595 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 3 4
            ((void *)0)
# 595 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c"
                ;
       pr = pixel_regions_process (pr))
    {
      const gint x1 = region.x + region.w;
            ...
            gint max_progress)
{
  PixelRegion region;
  PixelSurround *surround = 
# 641 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 3 4
                              ((void *)0)
# 641 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c"
                                  ;
  const guint bytes = tile_manager_bpp (dstTM);
  const guint dst_width = tile_manager_width (dstTM);
  const guint dst_height = tile_manager_height (dstTM);
 ...
 649
# 647 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c"
  , "SCALE", "decimate_x: %dx%d -> %dx%d\n", tile_manager_width (srcTM), tile_manager_height (srcTM), dst_width, dst_height); } while (0)
  ...
  for (pr = pixel_regions_register (1, &region);
       pr != 
# 656 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 3 4
            ((void *)0)
# 656 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c"
                ;
       pr = pixel_regions_process (pr))
    {
      const gint x1 = region.x + region.w;
            ...
            gint max_progress)
{
  PixelRegion region;
  PixelSurround *surround = 
# 701 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 3 4
                              ((void *)0)
# 701 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c"
                                  ;
  const guint bytes = tile_manager_bpp (dstTM);
  const guint dst_width = tile_manager_width (dstTM);
  const guint dst_height = tile_manager_height (dstTM);
 ...
 709
# 707 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c"
  , "SCALE", "decimate_y: %dx%d -> %dx%d\n", tile_manager_width (srcTM), tile_manager_height (srcTM), dst_width, dst_height); } while (0)
  ...
  for (pr = pixel_regions_register (1, &region);
       pr != 
# 716 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 3 4
            ((void *)0)
# 716 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c"
                ;
       pr = pixel_regions_process (pr))
    {
      const gint x1 = region.x + region.w;
...
create_lanczos_lookup (void)
{
  ...
  gfloat *lookup = (gfloat *) (__extension__ ({ gsize __n = (gsize) (((4000) * ((3) + 1))); gsize __s = sizeof (gfloat); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 971 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 3 4
                   (0x7fffffffffffffffL * 2UL + 1UL) 
# 971 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c"
...
create_lanczos3_lookup (void)
{
  ...
  gfloat *lookup = (gfloat *) (__extension__ ({ gsize __n = (gsize) (((4000) * ((3) + 1))); gsize __s = sizeof (gfloat); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 990 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c" 3 4
                   (0x7fffffffffffffffL * 2UL + 1UL) 
# 990 "/src/gimp-2.6.7/app/paint-funcs/scale-region.c"
                   / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
  gdouble x = 0.0;
  gint i;
                     ...
                     guchar *pixel)
{
  ...
  read_pixel_data_1 (srcTM, (((x) > (w)) ? (w) : (((x) < (0)) ? (0) : (x))), (((y) > (h)) ? (h) : (((y) < (0)) ? (0) : (y))), pixel);
}
