# 1 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c"
# 19 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c"
# 1 "../../config.h" 1
# 20 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c" 2
...
# 22 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c" 2
...
# 24 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c" 2
...
# 26 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c" 2
...
# 28 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c" 2
...
# 30 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c" 2
...
void combine_regions_replace (PixelRegion *src1,
                                           ...
                                           const gboolean *affect,
                                           CombinationMode type);
# 32 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c" 2
# 1 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.h" 1
# 23 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.h"
void reduce_region (PixelRegion *srcPR,
                     PixelRegion *destPR,
                     GimpProgressFunc progress_callback,
                     gpointer progress_data);
# 33 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c" 2
  ...
  if (level > 0)
    {
      ...
      guchar *dst = (guchar *) (__extension__ ({ gsize __n = (gsize) (width * height * bytes); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 82 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c" 3 4
                      (0x7fffffffffffffffL * 2UL + 1UL) 
# 82 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c"
          ...
          while (level)
            {
              ...
              dst = (guchar *) (__extension__ ({ gsize __n = (gsize) (width * height * bytes); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 96 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c" 3 4
                   (0x7fffffffffffffffL * 2UL + 1UL) 
# 96 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c"
                   / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
                     ...
                     gint bytes)
{
  ...
  src_buf = (guchar *) (__extension__ ({ gsize __n = (gsize) (src_width * bytes * 3); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 128 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c" 3 4
            (0x7fffffffffffffffL * 2UL + 1UL) 
# 128 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c"
            / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
               ...
               gint alpha)
{
  ...
  src_buf = (guchar *) (__extension__ ({ gsize __n = (gsize) (rowstride * 3); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 164 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c" 3 4
            (0x7fffffffffffffffL * 2UL + 1UL) 
# 164 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c"
            / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
            ...
            gint alpha)
{
  ...
  const guchar *src2;
  guchar *dstptr;
# 221 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c"
  dstptr = dst;
                 ...
                 gint bytes)
{
  ...
  dst = (guchar *) (__extension__ ({ gsize __n = (gsize) (dstPR->w * dstPR->h * bytes); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 289 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c" 3 4
       (0x7fffffffffffffffL * 2UL + 1UL) 
# 289 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c"
       / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
                    ...
                    PixelRegion *srcPR)
{
  ...
  src0 = (guchar *) (__extension__ ({ gsize __n = (gsize) (srcPR->w * bytes); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc0 (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 350 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c" 3 4
        (0x7fffffffffffffffL * 2UL + 1UL) 
# 350 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c"
        / __s)) __p = g_malloc0 (__n * __s); else __p = g_malloc0_n (__n, __s); __p; }));
  src1 = (guchar *) (__extension__ ({ gsize __n = (gsize) (srcPR->w * bytes); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc0 (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 351 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c" 3 4
        (0x7fffffffffffffffL * 2UL + 1UL) 
# 351 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c"
        / __s)) __p = g_malloc0 (__n * __s); else __p = g_malloc0_n (__n, __s); __p; }));
  dst = (guchar *) (__extension__ ({ gsize __n = (gsize) (dstPR->w * bytes); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc0 (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 352 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c" 3 4
        (0x7fffffffffffffffL * 2UL + 1UL) 
# 352 "/src/gimp-2.6.7/app/paint-funcs/reduce-region.c"
        / __s)) __p = g_malloc0 (__n * __s); else __p = g_malloc0_n (__n, __s); __p; }));
