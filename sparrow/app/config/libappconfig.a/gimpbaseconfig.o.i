# 1 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c"
# 22 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c"
# 1 "../../config.h" 1
# 23 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c" 2
...
# 26 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c" 2
...
# 29 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c" 2
...
# 31 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c" 2
...
# 32 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c" 2
...
# 34 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c" 2
...
void pixel_regions_process_parallel_progress
                                      (PixelProcessorFunc func,
                                       ...
                                       gint num_regions,
                                       ...);
# 38 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c" 2

# 1 "/src/gimp-2.6.7/app/config/gimprc-blurbs.h" 1
# 40 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c" 2
# 1 "/src/gimp-2.6.7/app/config/gimpbaseconfig.h" 1
# 35 "/src/gimp-2.6.7/app/config/gimpbaseconfig.h"
...
# 41 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c" 2
...
# 43 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c" 2



# 45 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c"
enum
{
  PROP_0,
  PROP_TEMP_PATH,
...
static void gimp_base_config_init (GimpBaseConfig *self); static void gimp_base_config_class_init (GimpBaseConfigClass *klass); static gpointer gimp_base_config_parent_class = 
# 69 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c" 3 4
((void *)0)
# 69 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c"
; static gint GimpBaseConfig_private_offset; static void gimp_base_config_class_intern_init (gpointer klass) { gimp_base_config_parent_class = g_type_class_peek_parent (klass); if (GimpBaseConfig_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpBaseConfig_private_offset); gimp_base_config_class_init ((GimpBaseConfigClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_base_config_get_instance_private (GimpBaseConfig *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpBaseConfig_private_offset)))); } GType gimp_base_config_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (gpointer) __atomic_load_8 ((&g_define_type_id__volatile), 5); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("GimpBaseConfig"), sizeof (GimpBaseConfigClass), (GClassInitFunc)(void (*)(void)) gimp_base_config_class_intern_init, sizeof (GimpBaseConfig), (GInstanceInitFunc)(void (*)(void)) gimp_base_config_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_3[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_base_config_class_init (GimpBaseConfigClass *klass)
{
  ...
  g_object_class_install_property (object_class, PROP_TEMP_PATH, gimp_param_spec_config_path ("temp-path", 
# 84 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c" 3 4
 ((void *)0)
# 84 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c"
 , ("Sets the folder for temporary storage. Files will appear here " "during the course of running GIMP.  Most files will disappear " "when GIMP exits, but some files are likely to remain, so it " "is best if this folder not be one that is shared by other users."), GIMP_CONFIG_PATH_DIR, "${gimp_dir}" "/" "tmp", (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (2 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))
                                                           ...
                                                           ;
  g_object_class_install_property (object_class, PROP_SWAP_PATH, gimp_param_spec_config_path ("swap-path", 
# 90 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c" 3 4
 ((void *)0)
# 90 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c"
 , ("Sets the swap file location. GIMP uses a tile based memory allocation " "scheme. The swap file is used to quickly and easily swap tiles out to " "disk and back in. Be aware that the swap file can easily get very large " "if GIMP is used with large images. " "Also, things can get horribly slow if the swap file is created on " "a folder that is mounted over NFS.  For these reasons, it may be " "desirable to put your swap file in \"/tmp\"."), GIMP_CONFIG_PATH_DIR, "${gimp_dir}", (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (2 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))
  ...
  g_object_class_install_property (object_class, PROP_NUM_PROCESSORS, g_param_spec_uint ("num-processors", 
# 103 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c" 3 4
 ((void *)0)
# 103 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c"
 , ("Sets how many processors GIMP should try to use simultaneously."), 1, 16, num_processors, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))


                                                           ;
  g_object_class_install_property (object_class, PROP_TILE_CACHE_SIZE, gimp_param_spec_memsize ("tile-cache-size", 
# 107 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c" 3 4
 ((void *)0)
# 107 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c"
 , ("When the amount of pixel data exceeds this limit, GIMP will start to " "swap tiles to disk.  This is a lot slower but it makes it possible to " "work on images that wouldn't fit into memory otherwise.  If you have a " "lot of RAM, you may want to set this to a higher value."), 0, (((
# 107 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c" 3 4
...
# 107 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c" 3 4
 (0x7fffffffffffffffL * 2UL + 1UL)
# 107 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c"
 ) : (((guint64) 1 << 42))), 1 << 30, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (3 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))
  ...
  g_object_class_install_property (object_class, PROP_STINGY_MEMORY_USE, g_param_spec_boolean ("stingy-memory-use", 
# 115 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c" 3 4
 ((void *)0)
# 115 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c"
 , 
# 115 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c" 3 4
 ((void *)0)
# 115 "/src/gimp-2.6.7/app/config/gimpbaseconfig.c"
 , (0), (1 << (5 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))
...
gimp_base_config_finalize (GObject *object)
{
  ...
  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_base_config_parent_class)), (((GType) ((20) << (2))))))))->finalize (object);
}
                               ...
                               GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_log ("Gimp-Config", G_LOG_LEVEL_WARNING, "%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'", "/src/gimp-2.6.7/app/config/gimpbaseconfig.c", 167, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
                               ...
                               GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_log ("Gimp-Config", G_LOG_LEVEL_WARNING, "%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'", "/src/gimp-2.6.7/app/config/gimpbaseconfig.c", 200, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
