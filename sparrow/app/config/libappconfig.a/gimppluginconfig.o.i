# 1 "/src/gimp-2.6.7/app/config/gimppluginconfig.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/app/config/gimppluginconfig.c"
# 22 "/src/gimp-2.6.7/app/config/gimppluginconfig.c"
# 1 "../../config.h" 1
# 23 "/src/gimp-2.6.7/app/config/gimppluginconfig.c" 2
...
# 25 "/src/gimp-2.6.7/app/config/gimppluginconfig.c" 2
...
# 27 "/src/gimp-2.6.7/app/config/gimppluginconfig.c" 2
...
# 28 "/src/gimp-2.6.7/app/config/gimppluginconfig.c" 2
...
# 30 "/src/gimp-2.6.7/app/config/gimppluginconfig.c" 2

# 1 "/src/gimp-2.6.7/app/config/gimprc-blurbs.h" 1
# 32 "/src/gimp-2.6.7/app/config/gimppluginconfig.c" 2
# 1 "/src/gimp-2.6.7/app/config/gimppluginconfig.h" 1
# 25 "/src/gimp-2.6.7/app/config/gimppluginconfig.h"
...
# 26 "/src/gimp-2.6.7/app/config/gimppluginconfig.h" 2
...
# 28 "/src/gimp-2.6.7/app/config/gimppluginconfig.h" 2
# 37 "/src/gimp-2.6.7/app/config/gimppluginconfig.h"
...
# 33 "/src/gimp-2.6.7/app/config/gimppluginconfig.c" 2
...
# 57 "/src/gimp-2.6.7/app/config/gimppluginconfig.c" 3 4
((void *)0)
# 57 "/src/gimp-2.6.7/app/config/gimppluginconfig.c"
; static gint GimpPluginConfig_private_offset; static void gimp_plugin_config_class_intern_init (gpointer klass) { gimp_plugin_config_parent_class = g_type_class_peek_parent (klass); if (GimpPluginConfig_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpPluginConfig_private_offset); gimp_plugin_config_class_init ((GimpPluginConfigClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_plugin_config_get_instance_private (GimpPluginConfig *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpPluginConfig_private_offset)))); } GType gimp_plugin_config_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (gpointer) __atomic_load_8 ((&g_define_type_id__volatile), 5); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_gui_config_get_type ()), g_intern_static_string ("GimpPluginConfig"), sizeof (GimpPluginConfigClass), (GClassInitFunc)(void (*)(void)) gimp_plugin_config_class_intern_init, sizeof (GimpPluginConfig), (GInstanceInitFunc)(void (*)(void)) gimp_plugin_config_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_3[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_plugin_config_class_init (GimpPluginConfigClass *klass)
{
  ...
  g_object_class_install_property (object_class, PROP_FRACTALEXPLORER_PATH, gimp_param_spec_config_path ("fractalexplorer-path", 
# 73 "/src/gimp-2.6.7/app/config/gimppluginconfig.c" 3 4
 ((void *)0)
# 73 "/src/gimp-2.6.7/app/config/gimppluginconfig.c"
 , "Where to search for fractals used by the Fractal Explorer plug-in.", GIMP_CONFIG_PATH_DIR_LIST, path, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))
  ...
  g_object_class_install_property (object_class, PROP_GFIG_PATH, gimp_param_spec_config_path ("gfig-path", 
# 82 "/src/gimp-2.6.7/app/config/gimppluginconfig.c" 3 4
 ((void *)0)
# 82 "/src/gimp-2.6.7/app/config/gimppluginconfig.c"
 , "Where to search for Gfig figures used by the Gfig plug-in.", GIMP_CONFIG_PATH_DIR_LIST, path, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))
  ...
  g_object_class_install_property (object_class, PROP_GFLARE_PATH, gimp_param_spec_config_path ("gflare-path", 
# 90 "/src/gimp-2.6.7/app/config/gimppluginconfig.c" 3 4
 ((void *)0)
# 90 "/src/gimp-2.6.7/app/config/gimppluginconfig.c"
 , "Where to search for gflares used by the GFlare plug-in.", GIMP_CONFIG_PATH_DIR_LIST, path, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))
  ...
  g_object_class_install_property (object_class, PROP_GIMPRESSIONIST_PATH, gimp_param_spec_config_path ("gimpressionist-path", 
# 98 "/src/gimp-2.6.7/app/config/gimppluginconfig.c" 3 4
 ((void *)0)
# 98 "/src/gimp-2.6.7/app/config/gimppluginconfig.c"
 , "Where to search for data used by the Gimpressionist plug-in.", GIMP_CONFIG_PATH_DIR_LIST, path, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))
  ...
  g_object_class_install_property (object_class, PROP_SCRIPT_FU_PATH, gimp_param_spec_config_path ("script-fu-path", 
# 107 "/src/gimp-2.6.7/app/config/gimppluginconfig.c" 3 4
 ((void *)0)
# 107 "/src/gimp-2.6.7/app/config/gimppluginconfig.c"
 , "This path will be searched for scripts when the Script-Fu plug-in is run.", GIMP_CONFIG_PATH_DIR_LIST, path, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))
                                 ...
                                 GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_log ("Gimp-Config", G_LOG_LEVEL_WARNING, "%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'", "/src/gimp-2.6.7/app/config/gimppluginconfig.c", 171, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
                                 ...
                                 GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_log ("Gimp-Config", G_LOG_LEVEL_WARNING, "%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'", "/src/gimp-2.6.7/app/config/gimppluginconfig.c", 207, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
