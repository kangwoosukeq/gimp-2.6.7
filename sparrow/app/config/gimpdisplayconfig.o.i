# 1 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
# 22 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
# 1 "../../config.h" 1
# 23 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 2
...
# 25 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 2
...
# 27 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 2
...
# 28 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 2
...
# 29 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 2
...
# 31 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 2
...
# 33 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 2
# 1 "../../app/display/gimpdisplayoptions.h" 1
# 37 "../../app/display/gimpdisplayoptions.h"
...
# 34 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 2

# 1 "/src/gimp-2.6.7/app/config/gimprc-blurbs.h" 1
# 36 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 2
# 1 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.h" 1
# 27 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.h"
...
# 28 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.h" 2
# 41 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.h"
...
# 37 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 2
...
# 39 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 2
...
# 45 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
enum
{
  PROP_0,
...
static void gimp_display_config_init (GimpDisplayConfig *self); static void gimp_display_config_class_init (GimpDisplayConfigClass *klass); static gpointer gimp_display_config_parent_class = 
# 95 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
((void *)0)
# 95 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
; static gint GimpDisplayConfig_private_offset; static void gimp_display_config_class_intern_init (gpointer klass) { gimp_display_config_parent_class = g_type_class_peek_parent (klass); if (GimpDisplayConfig_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpDisplayConfig_private_offset); gimp_display_config_class_init ((GimpDisplayConfigClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_display_config_get_instance_private (GimpDisplayConfig *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpDisplayConfig_private_offset)))); } GType gimp_display_config_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (gpointer) __atomic_load_8 ((&g_define_type_id__volatile), 5); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_core_config_get_type ()), g_intern_static_string ("GimpDisplayConfig"), sizeof (GimpDisplayConfigClass), (GClassInitFunc)(void (*)(void)) gimp_display_config_class_intern_init, sizeof (GimpDisplayConfig), (GInstanceInitFunc)(void (*)(void)) gimp_display_config_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_3[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_display_config_class_init (GimpDisplayConfigClass *klass)
{
  ...
  g_object_class_install_property (object_class, PROP_TRANSPARENCY_SIZE, g_param_spec_enum ("transparency-size", 
# 112 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 112 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , ("Sets the size of the checkerboard used to display transparency."), (gimp_check_size_get_type ()), GIMP_CHECK_SIZE_MEDIUM_CHECKS, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                           ;
  g_object_class_install_property (object_class, PROP_TRANSPARENCY_TYPE, g_param_spec_enum ("transparency-type", 
# 117 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 117 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , ("Sets the manner in which transparency is displayed in images."), (gimp_check_type_get_type ()), GIMP_CHECK_TYPE_GRAY_CHECKS, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                           ;
  g_object_class_install_property (object_class, PROP_SNAP_DISTANCE, g_param_spec_int ("snap-distance", 
# 122 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 122 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , ("This is the distance in pixels where Guide and Grid snapping " "activates."), 1, 255, 8, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))


                                                          ;
  g_object_class_install_property (object_class, PROP_MARCHING_ANTS_SPEED, g_param_spec_int ("marching-ants-speed", 
# 126 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 126 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , ("Speed of marching ants in the selection outline.  This value is in " "milliseconds (less time indicates faster marching)."), 10, 1000, 200, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                          ;
  g_object_class_install_property (object_class, PROP_RESIZE_WINDOWS_ON_ZOOM, g_param_spec_boolean ("resize-windows-on-zoom", 
# 131 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 131 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , ("When enabled, the image window will automatically resize itself " "when zooming into and out of images."), (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                              ;
  g_object_class_install_property (object_class, PROP_RESIZE_WINDOWS_ON_RESIZE, g_param_spec_boolean ("resize-windows-on-resize", 
# 136 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 136 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , ("When enabled, the image window will automatically resize itself " "whenever the physical image size changes."), (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                              ;
  g_object_class_install_property (object_class, PROP_DEFAULT_DOT_FOR_DOT, g_param_spec_boolean ("default-dot-for-dot", 
# 141 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 141 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , ("When enabled, this will ensure that each pixel of an image gets " "mapped to a pixel on the screen."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                              ;
  g_object_class_install_property (object_class, PROP_INITIAL_ZOOM_TO_FIT, g_param_spec_boolean ("initial-zoom-to-fit", 
# 146 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 146 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , ("When enabled, this will ensure that the full image is visible after a " "file is opened, otherwise it will be displayed with a scale of 1:1."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                              ;
  g_object_class_install_property (object_class, PROP_PERFECT_MOUSE, g_param_spec_boolean ("perfect-mouse", 
# 151 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 151 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , ("When enabled, the X server is queried for the mouse's current position " "on each motion event, rather than relying on the position hint.  This " "means painting with large brushes should be more accurate, but it may " "be slower.  Perversely, on some X servers enabling this option results " "in faster painting."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))
                                                              ...
                                                              ;
  g_object_class_install_property (object_class, PROP_CURSOR_MODE, g_param_spec_enum ("cursor-mode", 
# 155 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 155 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , ("Sets the type of mouse pointers to use."), (gimp_cursor_mode_get_type ()), GIMP_CURSOR_MODE_TOOL_ICON, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                           ;
  g_object_class_install_property (object_class, PROP_CURSOR_UPDATING, g_param_spec_boolean ("cursor-updating", 
# 160 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 160 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , ("Context-dependent mouse pointers are helpful.  They are enabled by " "default.  However, they require overhead that you may want to do without."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))


                                                              ;
  g_object_class_install_property (object_class, PROP_SHOW_BRUSH_OUTLINE, g_param_spec_boolean ("show-brush-outline", 
# 164 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 164 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , ("When enabled, all paint tools will show a preview of the current " "brush's outline."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                              ;
  g_object_class_install_property (object_class, PROP_SHOW_PAINT_TOOL_CURSOR, g_param_spec_boolean ("show-paint-tool-cursor", 
# 169 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 169 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , ("When enabled, the mouse pointer will be shown over the image while " "using a paint tool."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                              ;
  g_object_class_install_property (object_class, PROP_IMAGE_TITLE_FORMAT, g_param_spec_string ("image-title-format", 
# 174 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 174 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , ("Sets the text to appear in image window titles."), "%D*%f-%p.%i (%t, %L) %wx%h", (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                             ;
  g_object_class_install_property (object_class, PROP_IMAGE_STATUS_FORMAT, g_param_spec_string ("image-status-format", 
# 179 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 179 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , ("Sets the text to appear in image window status bars."), "%n (%m)", (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                             ;
  g_object_class_install_property (object_class, PROP_CONFIRM_ON_CLOSE, g_param_spec_boolean ("confirm-on-close", 
# 184 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 184 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , ("Ask for confirmation before closing an image without saving."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))


                                                              ;
  g_object_class_install_property (object_class, PROP_MONITOR_XRESOLUTION, g_param_spec_double ("monitor-xresolution", 
# 188 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 188 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , ("Sets the monitor's horizontal resolution, in dots per inch.  If set to " "0, forces the X server to be queried for both horizontal and vertical " "resolution information."), 5e-3, 65536.0, 96.0, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                                 ;
  g_object_class_install_property (object_class, PROP_MONITOR_YRESOLUTION, g_param_spec_double ("monitor-yresolution", 
# 193 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 193 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , ("Sets the monitor's vertical resolution, in dots per inch.  If set to " "0, forces the X server to be queried for both horizontal and vertical " "resolution information."), 5e-3, 65536.0, 96.0, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                                 ;
  g_object_class_install_property (object_class, PROP_MONITOR_RES_FROM_GDK, g_param_spec_boolean ("monitor-resolution-from-windowing-system", 
# 198 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 198 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , "When enabled, GIMP will use the monitor resolution from the windowing system.", (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                              ;
  g_object_class_install_property (object_class, PROP_NAV_PREVIEW_SIZE, g_param_spec_enum ("navigation-preview-size", 
# 203 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 203 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , ("Sets the size of the navigation preview available in the lower right " "corner of the image window."), (gimp_view_size_get_type ()), GIMP_VIEW_SIZE_MEDIUM, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))




                                                           ;
  g_object_class_install_property (object_class, PROP_DEFAULT_VIEW, g_param_spec_object ("default-view", 
# 209 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 209 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , "Sets the default settings for the image view.", (gimp_display_options_get_type ()), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (1 + (8))) | G_PARAM_READWRITE | (1 << (0 + (8)))))




                                                               ;
  g_object_class_install_property (object_class, PROP_DEFAULT_FULLSCREEN_VIEW, g_param_spec_object ("default-fullscreen-view", 
# 215 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 215 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , "Sets the default settings used when an image is viewed in fullscreen mode.", (gimp_display_options_get_type ()), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (1 + (8))) | G_PARAM_READWRITE | (1 << (0 + (8)))))




                                                               ;
  g_object_class_install_property (object_class, PROP_ACTIVATE_ON_FOCUS, g_param_spec_boolean ("activate-on-focus", 
# 221 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 221 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , ("When enabled, an image will become the active image when its image " "window receives the focus. This is useful for window managers using " "\"click to focus\"."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                              ;
  g_object_class_install_property (object_class, PROP_SPACE_BAR_ACTION, g_param_spec_enum ("space-bar-action", 
# 226 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 226 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , ("What to do when the space bar is pressed in the image window."), (gimp_space_bar_action_get_type ()), GIMP_SPACE_BAR_ACTION_PAN, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))




                                                           ;
  g_object_class_install_property (object_class, PROP_XOR_COLOR, gimp_param_spec_rgb ("xor-color", 
# 232 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 232 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , "Sets the color that is used for XOR drawing. This setting only exists as " "a workaround for buggy display drivers. If lines on the canvas are not " "correctly undrawn, try to set this to white.", (0), &color, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))


                                                          ;
  g_object_class_install_property (object_class, PROP_ZOOM_QUALITY, g_param_spec_enum ("zoom-quality", 
# 236 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 236 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , "There's a tradeoff between speed and quality of the zoomed-out display.", (gimp_zoom_quality_get_type ()), GIMP_ZOOM_QUALITY_HIGH, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))
...
{
  config->default_view =
    g_object_new ((gimp_display_options_get_type ()), 
# 248 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
                                            ((void *)0)
# 248 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
                                                );

  g_signal_connect_data ((config->default_view), ("notify"), (((GCallback) (gimp_display_config_view_notify))), (config), 
# 250 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 250 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , (GConnectFlags) 0)
  ...
  config->default_fullscreen_view =
    g_object_new ((gimp_display_options_get_type ()), 
# 255 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
                                            ((void *)0)
# 255 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
                                                );

  g_signal_connect_data ((config->default_fullscreen_view), ("notify"), (((GCallback) (gimp_display_config_fullscreen_notify))), (config), 
# 257 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c" 3 4
 ((void *)0)
# 257 "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c"
 , (GConnectFlags) 0)
                                  ...
                                  GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_log ("Gimp-Config", G_LOG_LEVEL_WARNING, "%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'", "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c", 376, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
                                  ...
                                  GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_log ("Gimp-Config", G_LOG_LEVEL_WARNING, "%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'", "/src/gimp-2.6.7/app/config/gimpdisplayconfig.c", 471, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
