# 1 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c"
# 22 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c"
# 1 "../../config.h" 1
# 23 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c" 2
...
# 25 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c" 2
...
# 27 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c" 2
...
# 28 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c" 2
...
# 30 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c" 2

# 1 "/src/gimp-2.6.7/app/config/gimpconfig-utils.h" 1
# 26 "/src/gimp-2.6.7/app/config/gimpconfig-utils.h"
...
void gimp_config_disconnect (GObject *a,
                                 GObject *b);
# 32 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c" 2
  ...
  if (param_spec->flags & G_PARAM_READABLE)
    {
      ...
      if (dest_spec &&
          ...
          (dest_spec->flags & G_PARAM_CONSTRUCT_ONLY) == 0)
        {
          ...
          g_signal_handlers_block_matched ((dest), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, 
# 57 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c" 3 4
         ((void *)0)
# 57 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c"
         , (gimp_config_connect_notify), (src))
                                                                           ;
          g_object_set_property (dest, param_spec->name, &value);
          g_signal_handlers_unblock_matched ((dest), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, 
# 60 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c" 3 4
         ((void *)0)
# 60 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c"
         , (gimp_config_connect_notify), (src))
                                                                             ;
...
# 82 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c"
void
                     ...
                     const gchar *property_name)
{
  ...
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((a != b)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Config", ((const char*) (__func__)), "a != b"); return; }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (((((g_type_check_instance_is_fundamentally_a ((GTypeInstance*) ((a)), (((GType) ((20) << (2)))))))) && (((g_type_check_instance_is_fundamentally_a ((GTypeInstance*) ((b)), (((GType) ((20) << (2)))))))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Config", ((const char*) (__func__)), "G_IS_OBJECT (a) && G_IS_OBJECT (b)"); return; }; }while (0);

  if (property_name)
    signal_name = g_strconcat ("notify::", property_name, 
# 93 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c" 3 4
                                                         ((void *)0)
# 93 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c"
                                                             );
  else
    signal_name = "notify";
  ...
  if (param_spec->flags & G_PARAM_READABLE)
    {
      ...
      GParamSpec *dest_spec = 
# 117 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c" 3 4
                             ((void *)0)
# 117 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c"
                                 ;
      ...
      if (dest_spec &&
          ...
          (dest_spec->flags & G_PARAM_CONSTRUCT_ONLY) == 0)
        {
          ...
          g_signal_handlers_block_matched ((dest), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, 
# 138 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c" 3 4
         ((void *)0)
# 138 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c"
         , (gimp_config_connect_full_notify), (src))
                                                                                ;
          g_object_set_property (dest, dest_prop_name, &value);
          g_signal_handlers_unblock_matched ((dest), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, 
# 141 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c" 3 4
         ((void *)0)
# 141 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c"
         , (gimp_config_connect_full_notify), (src))
                                                                                  ;
...
# 164 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c"
void
                          ...
                          const gchar *property_name_b)
{
  ...
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((a != b)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Config", ((const char*) (__func__)), "a != b"); return; }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (((((g_type_check_instance_is_fundamentally_a ((GTypeInstance*) ((a)), (((GType) ((20) << (2)))))))) && (((g_type_check_instance_is_fundamentally_a ((GTypeInstance*) ((b)), (((GType) ((20) << (2)))))))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Config", ((const char*) (__func__)), "G_IS_OBJECT (a) && G_IS_OBJECT (b)"); return; }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((property_name_a != 
# 175 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c" 3 4
 ((void *)0)
# 175 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Config", ((const char*) (__func__)), "property_name_a != NULL"); return; }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((property_name_b != 
# 176 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c" 3 4
 ((void *)0)
# 176 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Config", ((const char*) (__func__)), "property_name_b != NULL"); return; }; }while (0);

  signal_name = g_strconcat ("notify::", property_name_a, 
# 178 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c" 3 4
                                                         ((void *)0)
# 178 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c"
                                                             );
  ...
  signal_name = g_strconcat ("notify::", property_name_b, 
# 190 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c" 3 4
                                                         ((void *)0)
# 190 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c"
                                                             );
...
# 211 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c"
void
                        ...
                        GObject *b)
{
  ...
  g_signal_handlers_disconnect_matched ((b), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, 
# 217 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c" 3 4
 ((void *)0)
# 217 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c"
 , (((GCallback) (gimp_config_connect_notify))), (a))

                                          ;
  g_signal_handlers_disconnect_matched ((a), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, 
# 220 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c" 3 4
 ((void *)0)
# 220 "/src/gimp-2.6.7/app/config/gimpconfig-utils.c"
 , (((GCallback) (gimp_config_connect_notify))), (b))
