# 1 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
# 1 "/src/gimp-2.6.7/app/config//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
# 22 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
# 1 "../../config.h" 1
# 23 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 2
...
# 25 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 2
...
# 27 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 2
...
# 28 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 2

# 1 "/src/gimp-2.6.7/app/config/config-types.h" 1
# 29 "/src/gimp-2.6.7/app/config/config-types.h"
...
# 30 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 2

# 1 "/src/gimp-2.6.7/app/config/gimprc-blurbs.h" 1
# 32 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 2
# 1 "/src/gimp-2.6.7/app/config/gimpguiconfig.h" 1
# 25 "/src/gimp-2.6.7/app/config/gimpguiconfig.h"
# 1 "../../app/widgets/widgets-enums.h" 1
# 29 "../../app/widgets/widgets-enums.h"
GType gimp_active_color_get_type (void) __attribute__((__const__));
...
GType gimp_color_dialog_state_get_type (void) __attribute__((__const__));
...
GType gimp_color_frame_mode_get_type (void) __attribute__((__const__));

typedef enum
{
  GIMP_COLOR_FRAME_MODE_PIXEL,
  GIMP_COLOR_FRAME_MODE_RGB,
  GIMP_COLOR_FRAME_MODE_HSV,
  GIMP_COLOR_FRAME_MODE_CMYK
} GimpColorFrameMode;




GType gimp_color_pick_mode_get_type (void) __attribute__((__const__));

typedef enum
{
  GIMP_COLOR_PICK_MODE_NONE,
  GIMP_COLOR_PICK_MODE_FOREGROUND,
  GIMP_COLOR_PICK_MODE_BACKGROUND,
  GIMP_COLOR_PICK_MODE_PALETTE
} GimpColorPickMode;




GType gimp_color_pick_state_get_type (void) __attribute__((__const__));
...
GType gimp_histogram_scale_get_type (void) __attribute__((__const__));
...
GType gimp_tab_style_get_type (void) __attribute__((__const__));
...
typedef enum
{
  ...
  GIMP_TAB_STYLE_NAME,
  GIMP_TAB_STYLE_BLURB,
  GIMP_TAB_STYLE_ICON_NAME,
...
# 26 "/src/gimp-2.6.7/app/config/gimpguiconfig.h" 2

# 1 "../../app/config/gimpdisplayconfig.h" 1
# 25 "../../app/config/gimpdisplayconfig.h"
# 1 "../../app/display/display-enums.h" 1
# 25 "../../app/display/display-enums.h"
...
# 26 "../../app/config/gimpdisplayconfig.h" 2

# 1 "../../app/config/gimpcoreconfig.h" 1
# 25 "../../app/config/gimpcoreconfig.h"
# 1 "../../app/core/core-enums.h" 1
# 42 "../../app/core/core-enums.h"
...
# 26 "../../app/config/gimpcoreconfig.h" 2

# 1 "../../app/config/gimpbaseconfig.h" 1
# 25 "../../app/config/gimpbaseconfig.h"
# 1 "../../app/base/base-enums.h" 1
# 40 "../../app/base/base-enums.h"
...
# 26 "../../app/config/gimpbaseconfig.h" 2
# 35 "../../app/config/gimpbaseconfig.h"
...
# 28 "../../app/config/gimpcoreconfig.h" 2
# 37 "../../app/config/gimpcoreconfig.h"
...
# 28 "../../app/config/gimpdisplayconfig.h" 2
# 41 "../../app/config/gimpdisplayconfig.h"
...
# 28 "/src/gimp-2.6.7/app/config/gimpguiconfig.h" 2
# 37 "/src/gimp-2.6.7/app/config/gimpguiconfig.h"
...
# 33 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 2
...
# 35 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 2
# 52 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
...
# 106 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
((void *)0)
# 106 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
; static gint GimpGuiConfig_private_offset; static void gimp_gui_config_class_intern_init (gpointer klass) { gimp_gui_config_parent_class = g_type_class_peek_parent (klass); if (GimpGuiConfig_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpGuiConfig_private_offset); gimp_gui_config_class_init ((GimpGuiConfigClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_gui_config_get_instance_private (GimpGuiConfig *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpGuiConfig_private_offset)))); } GType gimp_gui_config_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (gpointer) __atomic_load_8 ((&g_define_type_id__volatile), 5); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_display_config_get_type ()), g_intern_static_string ("GimpGuiConfig"), sizeof (GimpGuiConfigClass), (GClassInitFunc)(void (*)(void)) gimp_gui_config_class_intern_init, sizeof (GimpGuiConfig), (GInstanceInitFunc)(void (*)(void)) gimp_gui_config_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_3[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_gui_config_class_init (GimpGuiConfigClass *klass)
{
  ...
  g_object_class_install_property (object_class, PROP_DEFAULT_THRESHOLD, g_param_spec_int ("default-threshold", 
# 121 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 121 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , ("Tools such as fuzzy-select and bucket fill find regions based on a " "seed-fill algorithm.  The seed fill starts at the initially selected " "pixel and progresses in all directions until the difference of pixel " "intensity from the original is greater than a specified threshold. " "This value represents the default threshold."), 0, 255, 15, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))


                                                          ;
  g_object_class_install_property (object_class, PROP_MOVE_TOOL_CHANGES_ACTIVE, g_param_spec_boolean ("move-tool-changes-active", 
# 125 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 125 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , ("If enabled, the move tool sets the edited layer or path as active.  " "This used to be the default behaviour in older versions."), (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                              ;
  g_object_class_install_property (object_class, PROP_TRUST_DIRTY_FLAG, g_param_spec_boolean ("trust-dirty-flag", 
# 130 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 130 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , ("When enabled, GIMP will not save an image if it has not been changed " "since it was opened."), (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                              ;
  g_object_class_install_property (object_class, PROP_SAVE_DEVICE_STATUS, g_param_spec_boolean ("save-device-status", 
# 135 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 135 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , ("Remember the current tool, pattern, color, and brush across GIMP " "sessions."), (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                              ;
  g_object_class_install_property (object_class, PROP_SAVE_SESSION_INFO, g_param_spec_boolean ("save-session-info", 
# 140 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 140 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , ("Save the positions and sizes of the main dialogs when GIMP exits."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                              ;
  g_object_class_install_property (object_class, PROP_RESTORE_SESSION, g_param_spec_boolean ("restore-session", 
# 145 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 145 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , ("Let GIMP try to restore your last saved session on each startup."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))


                                                              ;
  g_object_class_install_property (object_class, PROP_SAVE_TOOL_OPTIONS, g_param_spec_boolean ("save-tool-options", 
# 149 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 149 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , ("Save the tool options when GIMP exits."), (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                              ;
  g_object_class_install_property (object_class, PROP_SHOW_TOOLTIPS, g_param_spec_boolean ("show-tooltips", 
# 154 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 154 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , ("Show a tooltip when the pointer hovers over an item."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (2 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                              ;
  g_object_class_install_property (object_class, PROP_TEAROFF_MENUS, g_param_spec_boolean ("tearoff-menus", 
# 159 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 159 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , ("When enabled, menus can be torn off."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))


                                                              ;
  g_object_class_install_property (object_class, PROP_CAN_CHANGE_ACCELS, g_param_spec_boolean ("can-change-accels", 
# 163 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 163 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , ("When enabled, you can change keyboard shortcuts for menu items " "by hitting a key combination while the menu item is highlighted."), (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))


                                                              ;
  g_object_class_install_property (object_class, PROP_SAVE_ACCELS, g_param_spec_boolean ("save-accels", 
# 167 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 167 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , ("Save changed keyboard shortcuts when GIMP exits."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))


                                                              ;
  g_object_class_install_property (object_class, PROP_RESTORE_ACCELS, g_param_spec_boolean ("restore-accels", 
# 171 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 171 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , ("Restore saved keyboard shortcuts on each GIMP startup."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))


                                                              ;
  g_object_class_install_property (object_class, PROP_MENU_MNEMONICS, g_param_spec_boolean ("menu-mnemonics", 
# 175 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 175 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , ("When enabled, GIMP will show mnemonics in menus."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (2 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                              ;
  g_object_class_install_property (object_class, PROP_LAST_OPENED_SIZE, g_param_spec_int ("last-opened-size", 
# 180 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 180 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , ("How many recently opened image filenames to keep on the File menu."), 0, 1024, 10, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (2 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                          ;
  g_object_class_install_property (object_class, PROP_MAX_NEW_IMAGE_SIZE, gimp_param_spec_memsize ("max-new-image-size", 
# 185 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 185 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , ("GIMP will warn the user if an attempt is made to create an image that " "would take more memory than the size specified here."), 0, ((guint64) 1 << 42), 1 << 27, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                              ;
  g_object_class_install_property (object_class, PROP_TOOLBOX_COLOR_AREA, g_param_spec_boolean ("toolbox-color-area", 
# 190 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 190 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , ("Show the current foreground and background colors in the toolbox."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                              ;
  g_object_class_install_property (object_class, PROP_TOOLBOX_FOO_AREA, g_param_spec_boolean ("toolbox-foo-area", 
# 195 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 195 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , ("Show the currently selected brush, pattern and gradient in the toolbox."), (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                              ;
  g_object_class_install_property (object_class, PROP_TOOLBOX_IMAGE_AREA, g_param_spec_boolean ("toolbox-image-area", 
# 200 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 200 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , ("Show the currently active image in the toolbox."), (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                              ;
  g_object_class_install_property (object_class, PROP_TOOLBOX_WILBER, g_param_spec_boolean ("toolbox-wilber", 
# 205 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 205 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , "Show the GIMP mascot at the top of the toolbox.", (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                              ;
  path = gimp_config_build_data_path ("themes");
  g_object_class_install_property (object_class, PROP_THEME_PATH, gimp_param_spec_config_path ("theme-path", 
# 211 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 211 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , "Sets the theme search path.", GIMP_CONFIG_PATH_DIR_LIST, path, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (2 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                           ;
  g_free (path);
  g_object_class_install_property (object_class, PROP_THEME, g_param_spec_string ("theme", 
# 217 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 217 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , "The name of the theme to use.", "Default", (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))


                                                             ;
  g_object_class_install_property (object_class, PROP_USE_HELP, g_param_spec_boolean ("use-help", 
# 221 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 221 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , ("When enabled, pressing F1 will open the help browser."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))


                                                              ;
  g_object_class_install_property (object_class, PROP_SHOW_HELP_BUTTON, g_param_spec_boolean ("show-help-button", 
# 225 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 225 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , ("When enabled, dialogs will show a help button that gives access to " "the related help page.  Without this button, the help page can still " "be reached by pressing F1."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))


                                                              ;
  g_object_class_install_property (object_class, PROP_HELP_LOCALES, g_param_spec_string ("help-locales", 
# 229 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 229 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , "Specifies the language preferences used by the help system. This is a " "colon-separated list of language identifiers with decreasing priority. " "If empty, the language is taken from the user's locale setting.", "", (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))


                                                             ;
  g_object_class_install_property (object_class, PROP_HELP_BROWSER, g_param_spec_enum ("help-browser", 
# 233 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 233 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , ("Sets the browser used by the help system."), (gimp_help_browser_type_get_type ()), GIMP_HELP_BROWSER_GIMP, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                           ;
  g_object_class_install_property (object_class, PROP_WEB_BROWSER, gimp_param_spec_config_path ("web-browser", 
# 238 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 238 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , ("Sets the external web browser to be used.  This can be an absolute " "path or the name of an executable to search for in the user's PATH. " "If the command contains '%s' it will be replaced with the URL, else " "the URL will be appended to the command with a space separating the " "two."), GIMP_CONFIG_PATH_FILE, "firefox %s", (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                           ;
  g_object_class_install_property (object_class, PROP_USER_MANUAL_ONLINE, g_param_spec_boolean ("user-manual-online", 
# 243 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 243 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , "When enabled, the online user manual will be used by the help system. " "Otherwise the locally installed copy is used.", (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                              ;
  g_object_class_install_property (object_class, PROP_USER_MANUAL_ONLINE_URI, g_param_spec_string ("user-manual-online-uri", 
# 248 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 248 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , "The location of the online user manual. This is used if " "'user-manual-online' is enabled.", "http://docs.gimp.org/" "2.6", (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))



                                                             ;
  g_object_class_install_property (object_class, PROP_TOOLBOX_WINDOW_HINT, g_param_spec_enum ("toolbox-window-hint", 
# 253 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 253 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , ("The window type hint that is set on the toolbox. This may affect " "how your window manager decorates and handles the toolbox window."), (gimp_window_hint_get_type ()), GIMP_WINDOW_HINT_UTILITY, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (2 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))
                                                           ...
                                                           ;
  g_object_class_install_property (object_class, PROP_DOCK_WINDOW_HINT, g_param_spec_enum ("dock-window-hint", 
# 260 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 260 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , ("The window type hint that is set on dock windows. This may affect " "the way your window manager decorates and handles dock windows."), (gimp_window_hint_get_type ()), GIMP_WINDOW_HINT_UTILITY, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (2 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))
                                                           ...
                                                           ;
  g_object_class_install_property (object_class, PROP_TRANSIENT_DOCKS, g_param_spec_boolean ("transient-docks", 
# 267 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 267 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , ("When enabled, dock windows (the toolbox and palettes) are set to be " "transient to the active image window. Most window managers will " "keep the dock windows above the image window then, but it may also " "have other effects."), (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))
                                                              ...
                                                              ;
  g_object_class_install_property (object_class, PROP_CURSOR_FORMAT, g_param_spec_enum ("cursor-format", 
# 271 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 271 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , ("Sets the pixel format to use for mouse pointers."), (gimp_cursor_format_get_type ()), GIMP_CURSOR_FORMAT_PIXBUF, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))
  ...
  g_object_class_install_property (object_class, PROP_INFO_WINDOW_PER_DISPLAY, g_param_spec_boolean ("info-window-per-display", 
# 278 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 278 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , 
# 278 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 278 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (5 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))




                                                             ;
  g_object_class_install_property (object_class, PROP_SHOW_TOOL_TIPS, g_param_spec_boolean ("show-tool-tips", 
# 284 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 284 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , 
# 284 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 284 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (5 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))))
                                                             ...
                                                             ;
  g_object_class_install_property (object_class, PROP_SHOW_TIPS, g_param_spec_boolean ("show-tips", 
# 289 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 289 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
 , 
# 289 "/src/gimp-2.6.7/app/config/gimpguiconfig.c" 3 4
 ((void *)0)
# 289 "/src/gimp-2.6.7/app/config/gimpguiconfig.c"
                              ...
                              GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_log ("Gimp-Config", G_LOG_LEVEL_WARNING, "%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'", "/src/gimp-2.6.7/app/config/gimpguiconfig.c", 434, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
                              ...
                              GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_log ("Gimp-Config", G_LOG_LEVEL_WARNING, "%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'", "/src/gimp-2.6.7/app/config/gimpguiconfig.c", 553, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
