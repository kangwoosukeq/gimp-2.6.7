# 1 "/src/gimp-2.6.7/app/base/tile-swap.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/app/base/tile-swap.c"
# 19 "/src/gimp-2.6.7/app/base/tile-swap.c"
# 1 "../../config.h" 1
# 20 "/src/gimp-2.6.7/app/base/tile-swap.c" 2
...
# 22 "/src/gimp-2.6.7/app/base/tile-swap.c" 2
...
# 23 "/src/gimp-2.6.7/app/base/tile-swap.c" 2
...
# 24 "/src/gimp-2.6.7/app/base/tile-swap.c" 2
...
# 27 "/src/gimp-2.6.7/app/base/tile-swap.c" 2
...
# 30 "/src/gimp-2.6.7/app/base/tile-swap.c" 2
...
# 31 "/src/gimp-2.6.7/app/base/tile-swap.c" 2
...
# 33 "/src/gimp-2.6.7/app/base/tile-swap.c" 2
...
# 34 "/src/gimp-2.6.7/app/base/tile-swap.c" 2
...
# 41 "/src/gimp-2.6.7/app/base/tile-swap.c" 2
# 49 "/src/gimp-2.6.7/app/base/tile-swap.c"
# 1 "/src/gimp-2.6.7/app/base/base-utils.h" 1
# 23 "/src/gimp-2.6.7/app/base/base-utils.h"
gint get_pid (void);
gint get_number_of_processors (void);
guint64 get_physical_memory_size (void);
# 50 "/src/gimp-2.6.7/app/base/tile-swap.c" 2
...
void tile_detach (Tile *tile,
                                  void *tm,
                                  gint tile_num);
# 51 "/src/gimp-2.6.7/app/base/tile-swap.c" 2
...
void tile_update_rowhints (Tile *tile,
                                      gint start,
                                      gint rows);
# 52 "/src/gimp-2.6.7/app/base/tile-swap.c" 2
...
# 53 "/src/gimp-2.6.7/app/base/tile-swap.c" 2
...
# 54 "/src/gimp-2.6.7/app/base/tile-swap.c" 2
...
# 56 "/src/gimp-2.6.7/app/base/tile-swap.c" 2



# 58 "/src/gimp-2.6.7/app/base/tile-swap.c"
typedef enum
{
  SWAP_IN = 1,
  SWAP_OUT,
...
static SwapFile * gimp_swap_file = 
# 112 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
                                        ((void *)0)
# 112 "/src/gimp-2.6.7/app/base/tile-swap.c"
                                            ;

static const gint64 swap_file_grow = 1024 * 64 * 64 * 4;

static gboolean seek_err_msg = (!(0));
static gboolean read_err_msg = (!(0));
static gboolean write_err_msg = (!(0));
# 161 "/src/gimp-2.6.7/app/base/tile-swap.c"
void
tile_swap_init (const gchar *path)
{
  ...
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((gimp_swap_file == 
# 167 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
 ((void *)0)
# 167 "/src/gimp-2.6.7/app/base/tile-swap.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "gimp_swap_file == NULL"); return; }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((path != 
# 168 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
 ((void *)0)
# 168 "/src/gimp-2.6.7/app/base/tile-swap.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "path != NULL"); return; }; }while (0);

  dirname = gimp_config_path_expand (path, (!(0)), 
# 170 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
                                                 ((void *)0)
# 170 "/src/gimp-2.6.7/app/base/tile-swap.c"
                                                     );
...
# 176 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
                         0400 
# 176 "/src/gimp-2.6.7/app/base/tile-swap.c"
                                 | 
# 176 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
                                   0100 
# 176 "/src/gimp-2.6.7/app/base/tile-swap.c"
...
# 177 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
                         (0400 >> 3) 
# 177 "/src/gimp-2.6.7/app/base/tile-swap.c"
                                 | 
# 177 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
                                   (0100 >> 3) 
# 177 "/src/gimp-2.6.7/app/base/tile-swap.c"
...
# 178 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
                         ((0400 >> 3) >> 3) 
# 178 "/src/gimp-2.6.7/app/base/tile-swap.c"
                                 | 
# 178 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
                                   ((0100 >> 3) >> 3)
# 178 "/src/gimp-2.6.7/app/base/tile-swap.c"
  ...
  gimp_swap_file->filename = g_build_filename (dirname, basename, 
# 182 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
                                                                      ((void *)0)
# 182 "/src/gimp-2.6.7/app/base/tile-swap.c"
                                                                          );
  gimp_swap_file->gaps = 
# 183 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
                                 ((void *)0)
# 183 "/src/gimp-2.6.7/app/base/tile-swap.c"
                                     ;
...
tile_swap_exit (void)
{
  ...
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((gimp_swap_file != 
# 205 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
 ((void *)0)
# 205 "/src/gimp-2.6.7/app/base/tile-swap.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "gimp_swap_file != NULL"); return; }; }while (0);
# 224 "/src/gimp-2.6.7/app/base/tile-swap.c"
  ...
  gimp_swap_file = 
# 229 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
                  ((void *)0)
# 229 "/src/gimp-2.6.7/app/base/tile-swap.c"
                      ;
}
...
{
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((gimp_swap_file != 
# 236 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
 ((void *)0)
# 236 "/src/gimp-2.6.7/app/base/tile-swap.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "gimp_swap_file != NULL"); return ((0)); }; }while (0);


  gimp_swap_file->fd = open (gimp_swap_file->filename,
                               
# 240 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
                              0100 
# 240 "/src/gimp-2.6.7/app/base/tile-swap.c"
                                      | 
# 240 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
                                        02 
# 240 "/src/gimp-2.6.7/app/base/tile-swap.c"
...
# 241 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
                              0400 
# 241 "/src/gimp-2.6.7/app/base/tile-swap.c"
                                      | 
# 241 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
                                        0200
# 241 "/src/gimp-2.6.7/app/base/tile-swap.c"
  ...
  if (gimp_swap_file->fd == -1)
    {
      ...
      if ((__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((gimp_swap_file->fd == -1)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 0)))
        return;
    }
...
# 314 "/src/gimp-2.6.7/app/base/tile-swap.c"
static void
  ...
  if (swap_file->cur_position != tile->swap_offset)
    {
      ...
      offset = lseek (swap_file->fd, tile->swap_offset, 
# 328 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
              0
# 328 "/src/gimp-2.6.7/app/base/tile-swap.c"
              );
      if (offset == -1)
        {
          if (seek_err_msg)
            g_log ("Gimp-Base", G_LOG_LEVEL_MESSAGE, "unable to seek to tile location on disk: %s", g_strerror (
# 332 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
           (*__errno_location ())
# 332 "/src/gimp-2.6.7/app/base/tile-swap.c"
           ))
                                          ;
          seek_err_msg = (0);
          return;
  ...
  while (nleft > 0)
    {
      ...
      while ((err == -1) && ((
# 350 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
                             (*__errno_location ()) 
# 350 "/src/gimp-2.6.7/app/base/tile-swap.c"
                                   == 
# 350 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
                                      11
# 350 "/src/gimp-2.6.7/app/base/tile-swap.c"
...
# 350 "/src/gimp-2.6.7/app/base/tile-swap.c"
      ...
      if (err <= 0)
        {
          if (read_err_msg)
            g_log ("Gimp-Base", G_LOG_LEVEL_MESSAGE, "unable to read tile data from disk: " "%s (%d/%d bytes read)", g_strerror (
# 355 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
           (*__errno_location ())
# 355 "/src/gimp-2.6.7/app/base/tile-swap.c"
           ), err, nleft)
                       ...
                       Tile *tile)
{
  ...
  if (swap_file->cur_position != newpos)
    {
      offset = lseek (swap_file->fd, newpos, 
# 392 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
              0
# 392 "/src/gimp-2.6.7/app/base/tile-swap.c"
              );
      ...
      if (offset == -1)
        {
          if (seek_err_msg)
            g_log ("Gimp-Base", G_LOG_LEVEL_MESSAGE, "unable to seek to tile location on disk: %s", g_strerror (
# 397 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
           (*__errno_location ())
# 397 "/src/gimp-2.6.7/app/base/tile-swap.c"
           ))
                                          ;
          seek_err_msg = (0);
          return;
  ...
  while (nleft > 0)
    {
      ...
      if (err <= 0)
        {
          if (write_err_msg)
            g_log ("Gimp-Base", G_LOG_LEVEL_MESSAGE, "unable to write tile data to disk: " "%s (%d/%d bytes written)", g_strerror (
# 414 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
           (*__errno_location ())
# 414 "/src/gimp-2.6.7/app/base/tile-swap.c"
           ), err, nleft)
...
{
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((swap_file->fd == -1)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "swap_file->fd == -1"); return; }; }while (0);


  swap_file->fd = open (swap_file->filename,
                          
# 549 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
                         0100 
# 549 "/src/gimp-2.6.7/app/base/tile-swap.c"
                                 | 
# 549 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
                                   02 
# 549 "/src/gimp-2.6.7/app/base/tile-swap.c"
...
# 550 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
                         0400 
# 550 "/src/gimp-2.6.7/app/base/tile-swap.c"
                                 | 
# 550 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
                                   0200
# 550 "/src/gimp-2.6.7/app/base/tile-swap.c"
  ...
  if (swap_file->fd == -1)
    g_log ("Gimp-Base", G_LOG_LEVEL_MESSAGE, 
# 553 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
   dcgettext (((void *)0), 
# 553 "/src/gimp-2.6.7/app/base/tile-swap.c"
  ...
  if (swap_file->swap_file_end > new_size)
    {
      if (ftruncate (swap_file->fd, new_size) != 0)
        {
          g_log ("Gimp-Base", G_LOG_LEVEL_MESSAGE, 
# 568 "/src/gimp-2.6.7/app/base/tile-swap.c" 3 4
         dcgettext (((void *)0), 
# 568 "/src/gimp-2.6.7/app/base/tile-swap.c"
