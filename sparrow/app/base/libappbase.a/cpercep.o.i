# 1 "/src/gimp-2.6.7/app/base/cpercep.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/app/base/cpercep.c"
# 57 "/src/gimp-2.6.7/app/base/cpercep.c"
# 1 "../../config.h" 1
# 58 "/src/gimp-2.6.7/app/base/cpercep.c" 2
...
# 60 "/src/gimp-2.6.7/app/base/cpercep.c" 2
...
# 62 "/src/gimp-2.6.7/app/base/cpercep.c" 2
...
void cpercep_space_to_rgb (double inr,
                            ...
                            double *outg,
                            double *outb);
# 69 "/src/gimp-2.6.7/app/base/cpercep.c" 2
# 107 "/src/gimp-2.6.7/app/base/cpercep.c"
...
# 149 "/src/gimp-2.6.7/app/base/cpercep.c"
...
{
  int i;
# 175 "/src/gimp-2.6.7/app/base/cpercep.c"
  for (i=0; i<11 ; i++)
    {
...
# 369 "/src/gimp-2.6.7/app/base/cpercep.c"
    }
  else
    {
      L = 0.0;
            ...
            double *inb)
{
  ...
  Z = (P - b / 200.0F);
  Z = znn * ffunc_inv(Z);
# 433 "/src/gimp-2.6.7/app/base/cpercep.c"
  *inl = X;
  *ina = Y;
  *inb = Z;
}
...
cpercep_rgb_to_space (double inr,
                      ...
                      double *outb)
{
# 473 "/src/gimp-2.6.7/app/base/cpercep.c"
  inr = powtable[(int)inr];
  ing = powtable[(int)ing];
  inb = powtable[(int)inb];
# 516 "/src/gimp-2.6.7/app/base/cpercep.c"
  rgb_to_xyz(&inr, &ing, &inb);
# 526 "/src/gimp-2.6.7/app/base/cpercep.c"
...
# 552 "/src/gimp-2.6.7/app/base/cpercep.c"
