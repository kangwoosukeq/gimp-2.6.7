# 1 "/src/gimp-2.6.7/app/base/color-balance.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/app/base/color-balance.c"
# 19 "/src/gimp-2.6.7/app/base/color-balance.c"
# 1 "../../config.h" 1
# 20 "/src/gimp-2.6.7/app/base/color-balance.c" 2
...
# 22 "/src/gimp-2.6.7/app/base/color-balance.c" 2
...
# 24 "/src/gimp-2.6.7/app/base/color-balance.c" 2
...
# 25 "/src/gimp-2.6.7/app/base/color-balance.c" 2
...
# 27 "/src/gimp-2.6.7/app/base/color-balance.c" 2

# 1 "/src/gimp-2.6.7/app/base/color-balance.h" 1
# 23 "/src/gimp-2.6.7/app/base/color-balance.h"
...
void color_balance (ColorBalance *cb,
                                           PixelRegion *srcPR,
                                           PixelRegion *destPR);
# 29 "/src/gimp-2.6.7/app/base/color-balance.c" 2
...
# 30 "/src/gimp-2.6.7/app/base/color-balance.c" 2
...
color_balance_init (ColorBalance *cb)
{
  ...
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((cb != 
# 59 "/src/gimp-2.6.7/app/base/color-balance.c" 3 4
 ((void *)0)
# 59 "/src/gimp-2.6.7/app/base/color-balance.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "cb != NULL"); return; }; }while (0);
...
color_balance_create_lookup_tables (ColorBalance *cb)
{
  ...
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((cb != 
# 80 "/src/gimp-2.6.7/app/base/color-balance.c" 3 4
 ((void *)0)
# 80 "/src/gimp-2.6.7/app/base/color-balance.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "cb != NULL"); return; }; }while (0);
  ...
  for (i = 0; i < 256; i++)
    {
      ...
      gdouble mid = 0.667 * (1 - ((((gdouble) i - 127.0) / 127.0) * (((gdouble) i - 127.0) / 127.0)));
