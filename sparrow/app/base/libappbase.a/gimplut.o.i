# 1 "/src/gimp-2.6.7/app/base/gimplut.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/app/base/gimplut.c"
# 21 "/src/gimp-2.6.7/app/base/gimplut.c"
# 1 "../../config.h" 1
# 22 "/src/gimp-2.6.7/app/base/gimplut.c" 2
...
# 24 "/src/gimp-2.6.7/app/base/gimplut.c" 2
...
# 26 "/src/gimp-2.6.7/app/base/gimplut.c" 2
...
# 28 "/src/gimp-2.6.7/app/base/gimplut.c" 2
...
# 29 "/src/gimp-2.6.7/app/base/gimplut.c" 2
...
gimp_lut_new (void)
{
  ...
  lut->luts = 
# 38 "/src/gimp-2.6.7/app/base/gimplut.c" 3 4
                  ((void *)0)
# 38 "/src/gimp-2.6.7/app/base/gimplut.c"
                      ;
  lut->nchannels = 0;
                ...
                gint nchannels)
{
  ...
  lut->luts = (guchar * *) (__extension__ ({ gsize __n = (gsize) (lut->nchannels); gsize __s = sizeof (guchar *); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 74 "/src/gimp-2.6.7/app/base/gimplut.c" 3 4
                  (0x7fffffffffffffffL * 2UL + 1UL) 
# 74 "/src/gimp-2.6.7/app/base/gimplut.c"
                  / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));

  for (i = 0; i < lut->nchannels; i++)
    {
      lut->luts[i] = (guchar *) (__extension__ ({ gsize __n = (gsize) (256); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 78 "/src/gimp-2.6.7/app/base/gimplut.c" 3 4
                    (0x7fffffffffffffffL * 2UL + 1UL) 
# 78 "/src/gimp-2.6.7/app/base/gimplut.c"
                    / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
                  ...
                  PixelRegion *destPR)
{
  ...
  guchar *dest;
  guchar *lut0 = 
# 107 "/src/gimp-2.6.7/app/base/gimplut.c" 3 4
                      ((void *)0)
# 107 "/src/gimp-2.6.7/app/base/gimplut.c"
                          , *lut1 = 
# 107 "/src/gimp-2.6.7/app/base/gimplut.c" 3 4
                                    ((void *)0)
# 107 "/src/gimp-2.6.7/app/base/gimplut.c"
  ...
  while (h--)
    {
      switch (lut->nchannels)
        ...
        default:
          g_log ("Gimp-Base", G_LOG_LEVEL_WARNING, "gimplut: Error: nchannels = %d\n", lut->nchannels);
          break;
        }
                         ...
                         PixelRegion *srcPR)
{
  ...
  guchar *src;
  guchar *lut0 = 
# 195 "/src/gimp-2.6.7/app/base/gimplut.c" 3 4
                ((void *)0)
# 195 "/src/gimp-2.6.7/app/base/gimplut.c"
                    , *lut1 = 
# 195 "/src/gimp-2.6.7/app/base/gimplut.c" 3 4
                              ((void *)0)
# 195 "/src/gimp-2.6.7/app/base/gimplut.c"
