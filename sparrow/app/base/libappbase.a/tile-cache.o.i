# 1 "/src/gimp-2.6.7/app/base/tile-cache.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/app/base/tile-cache.c"
# 19 "/src/gimp-2.6.7/app/base/tile-cache.c"
# 1 "../../config.h" 1
# 20 "/src/gimp-2.6.7/app/base/tile-cache.c" 2
...
# 22 "/src/gimp-2.6.7/app/base/tile-cache.c" 2
...
# 24 "/src/gimp-2.6.7/app/base/tile-cache.c" 2
...
void tile_detach (Tile *tile,
                                  void *tm,
                                  gint tile_num);
# 26 "/src/gimp-2.6.7/app/base/tile-cache.c" 2
...
# 27 "/src/gimp-2.6.7/app/base/tile-cache.c" 2
...
# 28 "/src/gimp-2.6.7/app/base/tile-cache.c" 2
...
void tile_update_rowhints (Tile *tile,
                                      gint start,
                                      gint rows);
# 29 "/src/gimp-2.6.7/app/base/tile-cache.c" 2
...
# 30 "/src/gimp-2.6.7/app/base/tile-cache.c" 2
...
static const gulong max_tile_size = 64 * 64 * 4;
static gulong cur_cache_size = 0;
static gulong max_cache_size = 0;
static gulong cur_cache_dirty = 0;
static TileList clean_list = { 
# 51 "/src/gimp-2.6.7/app/base/tile-cache.c" 3 4
                                         ((void *)0)
# 51 "/src/gimp-2.6.7/app/base/tile-cache.c"
                                             , 
# 51 "/src/gimp-2.6.7/app/base/tile-cache.c" 3 4
                                               ((void *)0) 
# 51 "/src/gimp-2.6.7/app/base/tile-cache.c"
                                                    };
static TileList dirty_list = { 
# 52 "/src/gimp-2.6.7/app/base/tile-cache.c" 3 4
                                         ((void *)0)
# 52 "/src/gimp-2.6.7/app/base/tile-cache.c"
                                             , 
# 52 "/src/gimp-2.6.7/app/base/tile-cache.c" 3 4
                                               ((void *)0) 
# 52 "/src/gimp-2.6.7/app/base/tile-cache.c"
...
# 58 "/src/gimp-2.6.7/app/base/tile-cache.c" 3 4
                                       ((void *)0)
# 58 "/src/gimp-2.6.7/app/base/tile-cache.c"
                                           ;
# 71 "/src/gimp-2.6.7/app/base/tile-cache.c"
void
tile_cache_init (gulong tile_cache_size)
{

  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((tile_cache_mutex == 
# 75 "/src/gimp-2.6.7/app/base/tile-cache.c" 3 4
 ((void *)0)
# 75 "/src/gimp-2.6.7/app/base/tile-cache.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "tile_cache_mutex == NULL"); return; }; }while (0);

  tile_cache_mutex = g_mutex_new ();


  clean_list.first = clean_list.last = 
# 80 "/src/gimp-2.6.7/app/base/tile-cache.c" 3 4
                                      ((void *)0)
# 80 "/src/gimp-2.6.7/app/base/tile-cache.c"
                                          ;
  dirty_list.first = dirty_list.last = 
# 81 "/src/gimp-2.6.7/app/base/tile-cache.c" 3 4
                                      ((void *)0)
# 81 "/src/gimp-2.6.7/app/base/tile-cache.c"
                                          ;
...
tile_cache_exit (void)
{
  ...
  if (cur_cache_size > 0)
    g_log ("Gimp-Base", G_LOG_LEVEL_WARNING, "tile cache not empty (%ld bytes left)", cur_cache_size);
  ...
  tile_cache_mutex = 
# 102 "/src/gimp-2.6.7/app/base/tile-cache.c" 3 4
                    ((void *)0)
# 102 "/src/gimp-2.6.7/app/base/tile-cache.c"
                        ;
  ...
  if (list)
    {
      ...
      tile->listhead = 
# 145 "/src/gimp-2.6.7/app/base/tile-cache.c" 3 4
                      ((void *)0)
# 145 "/src/gimp-2.6.7/app/base/tile-cache.c"
                          ;
      ...
      while ((cur_cache_size + max_tile_size) > max_cache_size)
        {
          if (! tile_cache_zorch_next ())
            {
              g_log ("Gimp-Base", G_LOG_LEVEL_WARNING, "cache: unable to find room for a tile");
              goto out;
            }
        }
  ...
  tile->next = 
# 172 "/src/gimp-2.6.7/app/base/tile-cache.c" 3 4
              ((void *)0)
# 172 "/src/gimp-2.6.7/app/base/tile-cache.c"
                  ;
...
# 193 "/src/gimp-2.6.7/app/base/tile-cache.c" 3 4
                                            ((void *)0)
# 193 "/src/gimp-2.6.7/app/base/tile-cache.c"
                                                , 
# 193 "/src/gimp-2.6.7/app/base/tile-cache.c" 3 4
                                                  ((void *)0)
# 193 "/src/gimp-2.6.7/app/base/tile-cache.c"
  ...
  if (list)
    {
      ...
      tile->listhead = 
# 252 "/src/gimp-2.6.7/app/base/tile-cache.c" 3 4
                      ((void *)0)
# 252 "/src/gimp-2.6.7/app/base/tile-cache.c"
                          ;
    }
}
  ...
  if (! tile->dirty)
    {
      g_free (tile->data);
      tile->data = 
# 278 "/src/gimp-2.6.7/app/base/tile-cache.c" 3 4
                  ((void *)0)
# 278 "/src/gimp-2.6.7/app/base/tile-cache.c"
                      ;
  ...
  if ((tile = dirty_list.first))
    {
      ...
      if (tile->next)
        tile->next->prev = 
# 307 "/src/gimp-2.6.7/app/base/tile-cache.c" 3 4
                          ((void *)0)
# 307 "/src/gimp-2.6.7/app/base/tile-cache.c"
                              ;
      else
        dirty_list.last = 
# 309 "/src/gimp-2.6.7/app/base/tile-cache.c" 3 4
                         ((void *)0)
# 309 "/src/gimp-2.6.7/app/base/tile-cache.c"
                             ;

      tile->next = 
# 311 "/src/gimp-2.6.7/app/base/tile-cache.c" 3 4
                  ((void *)0)
# 311 "/src/gimp-2.6.7/app/base/tile-cache.c"
                      ;
