# 1 "/src/gimp-2.6.7/app/base/curves.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/app/base/curves.c"
# 19 "/src/gimp-2.6.7/app/base/curves.c"
# 1 "../../config.h" 1
# 20 "/src/gimp-2.6.7/app/base/curves.c" 2
...
# 22 "/src/gimp-2.6.7/app/base/curves.c" 2
...
# 24 "/src/gimp-2.6.7/app/base/curves.c" 2
...
# 25 "/src/gimp-2.6.7/app/base/curves.c" 2
...
# 27 "/src/gimp-2.6.7/app/base/curves.c" 2

# 1 "/src/gimp-2.6.7/app/base/curves.h" 1
# 23 "/src/gimp-2.6.7/app/base/curves.h"
struct _Curves
{
  guchar curve[5][256];
};
...
gfloat curves_lut_func (Curves *curves,
                         ...
                         gint channel,
                         gfloat value);
# 29 "/src/gimp-2.6.7/app/base/curves.c" 2
...
# 30 "/src/gimp-2.6.7/app/base/curves.c" 2
...
curves_init (Curves *curves)
{
  ...
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((curves != 
# 39 "/src/gimp-2.6.7/app/base/curves.c" 3 4
 ((void *)0)
# 39 "/src/gimp-2.6.7/app/base/curves.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "curves != NULL"); return; }; }while (0);
