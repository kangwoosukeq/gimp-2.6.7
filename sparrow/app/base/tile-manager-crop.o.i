# 1 "/src/gimp-2.6.7/app/base/tile-manager-crop.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/app/base/tile-manager-crop.c"
# 19 "/src/gimp-2.6.7/app/base/tile-manager-crop.c"
# 1 "../../config.h" 1
# 20 "/src/gimp-2.6.7/app/base/tile-manager-crop.c" 2
...
# 22 "/src/gimp-2.6.7/app/base/tile-manager-crop.c" 2
...
# 24 "/src/gimp-2.6.7/app/base/tile-manager-crop.c" 2
...
void combine_regions_replace (PixelRegion *src1,
                                           ...
                                           const gboolean *affect,
                                           CombinationMode type);
# 26 "/src/gimp-2.6.7/app/base/tile-manager-crop.c" 2
...
# 28 "/src/gimp-2.6.7/app/base/tile-manager-crop.c" 2
...
void write_pixel_data_1 (TileManager *tm,
                                      ...
                                      gint y,
                                      const guchar *buffer);
# 29 "/src/gimp-2.6.7/app/base/tile-manager-crop.c" 2
# 1 "/src/gimp-2.6.7/app/base/tile-manager-crop.h" 1
# 23 "/src/gimp-2.6.7/app/base/tile-manager-crop.h"
TileManager * tile_manager_crop (TileManager *tiles,
                                 gint border);
# 30 "/src/gimp-2.6.7/app/base/tile-manager-crop.c" 2
...
# 46 "/src/gimp-2.6.7/app/base/tile-manager-crop.c" 3 4
 ((void *)0)
# 46 "/src/gimp-2.6.7/app/base/tile-manager-crop.c"
...
# 46 "/src/gimp-2.6.7/app/base/tile-manager-crop.c"
  ...
  pixel_region_init (&region, tiles, 0, 0, x1, y1, (0));

  for (pr = pixel_regions_register (1, &region);
       pr != 
# 60 "/src/gimp-2.6.7/app/base/tile-manager-crop.c" 3 4
            ((void *)0)
# 60 "/src/gimp-2.6.7/app/base/tile-manager-crop.c"
                ;
  ...
  x2 = (((x2 + 1) > (tile_manager_width (tiles))) ? (tile_manager_width (tiles)) : (((x2 + 1) < (0)) ? (0) : (x2 + 1)));
  y2 = (((y2 + 1) > (tile_manager_height (tiles))) ? (tile_manager_height (tiles)) : (((y2 + 1) < (0)) ? (0) : (y2 + 1)));
  ...
  if (empty)
    {
      ...
      new_tiles = 
# 103 "/src/gimp-2.6.7/app/base/tile-manager-crop.c" 3 4
                 ((void *)0)
# 103 "/src/gimp-2.6.7/app/base/tile-manager-crop.c"
                     ;
    }
  else if (x1 == 0 && y1 == 0 &&
