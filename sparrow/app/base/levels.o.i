# 1 "/src/gimp-2.6.7/app/base/levels.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/app/base/levels.c"
# 19 "/src/gimp-2.6.7/app/base/levels.c"
# 1 "../../config.h" 1
# 20 "/src/gimp-2.6.7/app/base/levels.c" 2
...
# 22 "/src/gimp-2.6.7/app/base/levels.c" 2
...
# 24 "/src/gimp-2.6.7/app/base/levels.c" 2
...
# 26 "/src/gimp-2.6.7/app/base/levels.c" 2
...
# 27 "/src/gimp-2.6.7/app/base/levels.c" 2
...
# 29 "/src/gimp-2.6.7/app/base/levels.c" 2

# 1 "/src/gimp-2.6.7/app/base/levels.h" 1
# 23 "/src/gimp-2.6.7/app/base/levels.h"
struct _Levels
{
  gdouble gamma[5];
...
gfloat levels_lut_func (Levels *levels,
                          ...
                          gint channel,
                          gfloat value);
# 31 "/src/gimp-2.6.7/app/base/levels.c" 2
...
levels_init (Levels *levels)
{
  ...
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((levels != 
# 40 "/src/gimp-2.6.7/app/base/levels.c" 3 4
 ((void *)0)
# 40 "/src/gimp-2.6.7/app/base/levels.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "levels != NULL"); return; }; }while (0);
