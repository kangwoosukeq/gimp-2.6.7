# 1 "/src/gimp-2.6.7/app/base/tile.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/app/base/tile.c"
# 19 "/src/gimp-2.6.7/app/base/tile.c"
# 1 "../../config.h" 1
# 20 "/src/gimp-2.6.7/app/base/tile.c" 2
...
# 22 "/src/gimp-2.6.7/app/base/tile.c" 2
...
# 24 "/src/gimp-2.6.7/app/base/tile.c" 2
...
void tile_detach (Tile *tile,
                                  void *tm,
                                  gint tile_num);
# 26 "/src/gimp-2.6.7/app/base/tile.c" 2
...
# 27 "/src/gimp-2.6.7/app/base/tile.c" 2
...
void write_pixel_data_1 (TileManager *tm,
                                      ...
                                      gint y,
                                      const guchar *buffer);
# 28 "/src/gimp-2.6.7/app/base/tile.c" 2
...
void tile_update_rowhints (Tile *tile,
                                      gint start,
                                      gint rows);
# 29 "/src/gimp-2.6.7/app/base/tile.c" 2
...
# 30 "/src/gimp-2.6.7/app/base/tile.c" 2
...
# 31 "/src/gimp-2.6.7/app/base/tile.c" 2
# 41 "/src/gimp-2.6.7/app/base/tile.c"
static gint tile_ref_count = 0;
# 56 "/src/gimp-2.6.7/app/base/tile.c"
...
tile_lock (Tile *tile)
{
  ...
  if (tile->data == 
# 100 "/src/gimp-2.6.7/app/base/tile.c" 3 4
                   ((void *)0)
# 100 "/src/gimp-2.6.7/app/base/tile.c"
                       )
    {
...
tile_alloc (Tile *tile)
{
  ...
  tile->data = (guchar *) (__extension__ ({ gsize __n = (gsize) (tile->size); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 171 "/src/gimp-2.6.7/app/base/tile.c" 3 4
              (0x7fffffffffffffffL * 2UL + 1UL) 
# 171 "/src/gimp-2.6.7/app/base/tile.c"
...
{
  if ((__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((tile->ref_count)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 0)))
    {
      g_log ("Gimp-Base", G_LOG_LEVEL_WARNING, "tried to destroy a ref'd tile");
      return;
    }
  if ((__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((tile->share_count)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 0)))
    {
  ...
  if (tile->data)
    {
      g_free (tile->data);
      tile->data = 
# 196 "/src/gimp-2.6.7/app/base/tile.c" 3 4
                  ((void *)0)
# 196 "/src/gimp-2.6.7/app/base/tile.c"
                      ;
    }
  if (tile->rowhint)
    {
      ...
      tile->rowhint = 
# 201 "/src/gimp-2.6.7/app/base/tile.c" 3 4
                     ((void *)0)
# 201 "/src/gimp-2.6.7/app/base/tile.c"
                         ;
    }
             ...
             gint tile_num)
{
  ...
  tile->share_count++;
# 280 "/src/gimp-2.6.7/app/base/tile.c"
             ...
             gint tile_num)
{
  ...
  for (link = &tile->tlink;
       *link != 
# 303 "/src/gimp-2.6.7/app/base/tile.c" 3 4
               ((void *)0)
# 303 "/src/gimp-2.6.7/app/base/tile.c"
                   ;
       link = &(*link)->next)
    {
  ...
  if ((__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((*link == 
# 310 "/src/gimp-2.6.7/app/base/tile.c" 3 4
     ((void *)0)
# 310 "/src/gimp-2.6.7/app/base/tile.c"
...
tile_data_pointer (Tile *tile,
                   ...
                   gint yoff)
{
  return ((tile)->data + (((yoff) % 64) * (tile)->ewidth + ((xoff) % 64)) * (tile)->bpp);
}
