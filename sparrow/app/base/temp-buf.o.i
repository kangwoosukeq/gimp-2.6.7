# 1 "/src/gimp-2.6.7/app/base/temp-buf.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/app/base/temp-buf.c"
# 19 "/src/gimp-2.6.7/app/base/temp-buf.c"
# 1 "../../config.h" 1
# 20 "/src/gimp-2.6.7/app/base/temp-buf.c" 2
...
# 22 "/src/gimp-2.6.7/app/base/temp-buf.c" 2
...
# 24 "/src/gimp-2.6.7/app/base/temp-buf.c" 2
...
# 26 "/src/gimp-2.6.7/app/base/temp-buf.c" 2
...
# 27 "/src/gimp-2.6.7/app/base/temp-buf.c" 2

# 1 "/src/gimp-2.6.7/app/base/base-types.h" 1
# 27 "/src/gimp-2.6.7/app/base/base-types.h"
...
# 29 "/src/gimp-2.6.7/app/base/temp-buf.c" 2

# 1 "../../app/paint-funcs/paint-funcs.h" 1
# 24 "../../app/paint-funcs/paint-funcs.h"
...
void combine_regions_replace (PixelRegion *src1,
                                           ...
                                           const gboolean *affect,
                                           CombinationMode type);
# 31 "/src/gimp-2.6.7/app/base/temp-buf.c" 2

# 1 "/src/gimp-2.6.7/app/base/pixel-region.h" 1
# 23 "/src/gimp-2.6.7/app/base/pixel-region.h"
struct _PixelRegion
{
  guchar *data;
  TileManager *tiles;
...
# 33 "/src/gimp-2.6.7/app/base/temp-buf.c" 2
# 1 "/src/gimp-2.6.7/app/base/temp-buf.h" 1
# 23 "/src/gimp-2.6.7/app/base/temp-buf.h"
struct _TempBuf
{
  gint bytes;
  gint width;
...
# 34 "/src/gimp-2.6.7/app/base/temp-buf.c" 2
...
# 52 "/src/gimp-2.6.7/app/base/temp-buf.c" 3 4
 ((void *)0)
# 52 "/src/gimp-2.6.7/app/base/temp-buf.c"
 ); }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((bytes > 0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "bytes > 0"); return (
# 53 "/src/gimp-2.6.7/app/base/temp-buf.c" 3 4
 ((void *)0)
# 53 "/src/gimp-2.6.7/app/base/temp-buf.c"
 ); }; }while (0);
  ...
  temp->data = (guchar *) (__extension__ ({ gsize __n = (gsize) (width * height * bytes); gsize __s = sizeof (guchar); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 63 "/src/gimp-2.6.7/app/base/temp-buf.c" 3 4
              (0x7fffffffffffffffL * 2UL + 1UL) 
# 63 "/src/gimp-2.6.7/app/base/temp-buf.c"
                    ...
                    GimpCheckSize check_size)
{
  ...
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((width > 0 && height > 0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "width > 0 && height > 0"); return (
# 126 "/src/gimp-2.6.7/app/base/temp-buf.c" 3 4
 ((void *)0)
# 126 "/src/gimp-2.6.7/app/base/temp-buf.c"
 ); }; }while (0);
  ...
  new = temp_buf_new (width, height, 3, 0, 0, 
# 146 "/src/gimp-2.6.7/app/base/temp-buf.c" 3 4
                                             ((void *)0)
# 146 "/src/gimp-2.6.7/app/base/temp-buf.c"
                                                 );
...
temp_buf_copy (TempBuf *src,
               TempBuf *dest)
{
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((src != 
# 175 "/src/gimp-2.6.7/app/base/temp-buf.c" 3 4
 ((void *)0)
# 175 "/src/gimp-2.6.7/app/base/temp-buf.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "src != NULL"); return (
# 175 "/src/gimp-2.6.7/app/base/temp-buf.c" 3 4
 ((void *)0)
# 175 "/src/gimp-2.6.7/app/base/temp-buf.c"
 ); }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((! dest || (dest->width == src->width && dest->height == src->height))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "! dest || (dest->width == src->width && dest->height == src->height)"); return (
# 176 "/src/gimp-2.6.7/app/base/temp-buf.c" 3 4
 ((void *)0)
# 176 "/src/gimp-2.6.7/app/base/temp-buf.c"
 ); }; }while (0)
                                                                      ;

  if (! dest)
    dest = temp_buf_new (src->width, src->height, src->bytes, 0, 0, 
# 180 "/src/gimp-2.6.7/app/base/temp-buf.c" 3 4
                                                                   ((void *)0)
# 180 "/src/gimp-2.6.7/app/base/temp-buf.c"
                                                                       );
  ...
  if (src->bytes != dest->bytes)
    {
      if (src->bytes == 4 && dest->bytes == 2)
        ...
        g_log ("Gimp-Base", G_LOG_LEVEL_WARNING, "temp_buf_copy(): unimplemented color conversion");
    }
  else
    {
...
{
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((width > 0 && height > 0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "width > 0 && height > 0"); return (
# 213 "/src/gimp-2.6.7/app/base/temp-buf.c" 3 4
 ((void *)0)
# 213 "/src/gimp-2.6.7/app/base/temp-buf.c"
 ); }; }while (0);

  if (! buf)
    {
      buf = temp_buf_new (width, height, bytes, x, y, 
# 217 "/src/gimp-2.6.7/app/base/temp-buf.c" 3 4
                                                     ((void *)0)
# 217 "/src/gimp-2.6.7/app/base/temp-buf.c"
                                                         );
    }
  else
    {
      ...
      if (size != (buf->width * buf->height * buf->bytes))
        {
          buf->data = (guchar *) (__extension__ ({ gsize __n = (gsize) (size); gsize __s = sizeof (guchar); gpointer __p = (gpointer) (buf->data); if (__s == 1) __p = g_realloc (__p, __n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 225 "/src/gimp-2.6.7/app/base/temp-buf.c" 3 4
                     (0x7fffffffffffffffL * 2UL + 1UL) 
# 225 "/src/gimp-2.6.7/app/base/temp-buf.c"
                ...
                gint new_height)
{
  ...
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((src != 
# 251 "/src/gimp-2.6.7/app/base/temp-buf.c" 3 4
 ((void *)0)
# 251 "/src/gimp-2.6.7/app/base/temp-buf.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "src != NULL"); return (
# 251 "/src/gimp-2.6.7/app/base/temp-buf.c" 3 4
 ((void *)0)
# 251 "/src/gimp-2.6.7/app/base/temp-buf.c"
 ); }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((new_width > 0 && new_height > 0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "new_width > 0 && new_height > 0"); return (
# 252 "/src/gimp-2.6.7/app/base/temp-buf.c" 3 4
 ((void *)0)
# 252 "/src/gimp-2.6.7/app/base/temp-buf.c"
 ); }; }while (0);
  ...
  dest = temp_buf_new (new_width,
                       ...
                       src->bytes,
                       0, 0, 
# 257 "/src/gimp-2.6.7/app/base/temp-buf.c" 3 4
                            ((void *)0)
# 257 "/src/gimp-2.6.7/app/base/temp-buf.c"
                                );
                    ...
                    gint dest_y)
{
  ...
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((src != 
# 304 "/src/gimp-2.6.7/app/base/temp-buf.c" 3 4
 ((void *)0)
# 304 "/src/gimp-2.6.7/app/base/temp-buf.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "src != NULL"); return (dest); }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((!dest || dest->bytes == src->bytes)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "!dest || dest->bytes == src->bytes"); return (dest); }; }while (0);

  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((width + dest_x > 0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "width + dest_x > 0"); return (dest); }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((height + dest_y > 0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "height + dest_y > 0"); return (dest); }; }while (0);

  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((!dest || dest->width >= width + dest_x)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "!dest || dest->width >= width + dest_x"); return (dest); }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((!dest || dest->height >= height + dest_y)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "!dest || dest->height >= height + dest_y"); return (dest); }; }while (0);
...
# 359 "/src/gimp-2.6.7/app/base/temp-buf.c" 3 4
 ((void *)0)
# 359 "/src/gimp-2.6.7/app/base/temp-buf.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "buf != NULL"); return; }; }while (0);
  ...
  switch (buf->bytes)
    ...
    default:
      do{ g_log ("Gimp-Base", G_LOG_LEVEL_CRITICAL, "file %s: line %d (%s): should not be reached", "/src/gimp-2.6.7/app/base/temp-buf.c", 394, ((const char*) (__func__))); return; }while (0);
      break;
    }
}
...
{
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((buf != 
# 402 "/src/gimp-2.6.7/app/base/temp-buf.c" 3 4
 ((void *)0)
# 402 "/src/gimp-2.6.7/app/base/temp-buf.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "buf != NULL"); return; }; }while (0);
                   ...
                   TempBuf *dest_buf)
{
  ...
  switch (dest_buf->bytes)
    {
    case 3:
      do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((src_buf->bytes == 1)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "src_buf->bytes == 1"); return; }; }while (0);
      while (num_pixels--)
        {
          guchar tmp;
    ...
    case 4:
      do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((src_buf->bytes == 2)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "src_buf->bytes == 2"); return; }; }while (0);
      while (num_pixels--)
        {
          guchar tmp;
    ...
    default:
      do{ g_log ("Gimp-Base", G_LOG_LEVEL_CRITICAL, "file %s: line %d (%s): should not be reached", "/src/gimp-2.6.7/app/base/temp-buf.c", 478, ((const char*) (__func__))); return; }while (0);
      break;
    }
}
                  ...
                  TempBuf *dest_buf)
{
  ...
  switch (dest_buf->bytes)
    {
    case 1:
      do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((src_buf->bytes == 3)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "src_buf->bytes == 3"); return; }; }while (0);
      while (num_pixels--)
        {
    ...
    case 2:
      do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((src_buf->bytes == 4)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "src_buf->bytes == 4"); return; }; }while (0);
      while (num_pixels--)
        {
          gint lum = ((src[0]) * (0.2126) + (src[1]) * (0.7152) + (src[2]) * (0.0722)) + 0.5;
    ...
    default:
      do{ g_log ("Gimp-Base", G_LOG_LEVEL_CRITICAL, "file %s: line %d (%s): should not be reached", "/src/gimp-2.6.7/app/base/temp-buf.c", 524, ((const char*) (__func__))); return; }while (0);
      break;
    }
}
