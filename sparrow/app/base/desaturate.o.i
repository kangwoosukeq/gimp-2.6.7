# 1 "/src/gimp-2.6.7/app/base/desaturate.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/app/base/desaturate.c"
# 19 "/src/gimp-2.6.7/app/base/desaturate.c"
# 1 "../../config.h" 1
# 20 "/src/gimp-2.6.7/app/base/desaturate.c" 2
...
# 22 "/src/gimp-2.6.7/app/base/desaturate.c" 2
...
# 24 "/src/gimp-2.6.7/app/base/desaturate.c" 2
...
# 26 "/src/gimp-2.6.7/app/base/desaturate.c" 2

# 1 "/src/gimp-2.6.7/app/base/desaturate.h" 1
# 23 "/src/gimp-2.6.7/app/base/desaturate.h"
void desaturate_region (GimpDesaturateMode *mode,
                         PixelRegion *srcPR,
                         PixelRegion *destPR);
# 28 "/src/gimp-2.6.7/app/base/desaturate.c" 2
...
# 29 "/src/gimp-2.6.7/app/base/desaturate.c" 2
...
desaturate_region (GimpDesaturateMode *mode,
                   ...
                   PixelRegion *destPR)
{
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((mode != 
# 47 "/src/gimp-2.6.7/app/base/desaturate.c" 3 4
 ((void *)0)
# 47 "/src/gimp-2.6.7/app/base/desaturate.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "mode != NULL"); return; }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((srcPR->bytes == destPR->bytes)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "srcPR->bytes == destPR->bytes"); return; }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((srcPR->bytes == 3 || srcPR->bytes == 4)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "srcPR->bytes == 3 || srcPR->bytes == 4"); return; }; }while (0);
  ...
  while (h--)
    {
      ...
      for (j = 0; j < srcPR->w; j++)
        {
          gint luminosity = ((s[0]) * (0.2126) + (s[1]) * (0.7152) + (s[2]) * (0.0722))
