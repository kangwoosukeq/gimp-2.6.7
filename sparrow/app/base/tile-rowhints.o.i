# 1 "/src/gimp-2.6.7/app/base/tile-rowhints.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/app/base/tile-rowhints.c"
# 19 "/src/gimp-2.6.7/app/base/tile-rowhints.c"
# 1 "../../config.h" 1
# 20 "/src/gimp-2.6.7/app/base/tile-rowhints.c" 2
...
# 22 "/src/gimp-2.6.7/app/base/tile-rowhints.c" 2
...
# 24 "/src/gimp-2.6.7/app/base/tile-rowhints.c" 2
...
void tile_detach (Tile *tile,
                                  void *tm,
                                  gint tile_num);
# 26 "/src/gimp-2.6.7/app/base/tile-rowhints.c" 2
...
void tile_update_rowhints (Tile *tile,
                                      gint start,
                                      gint rows);
# 27 "/src/gimp-2.6.7/app/base/tile-rowhints.c" 2
...
# 28 "/src/gimp-2.6.7/app/base/tile-rowhints.c" 2
                  ...
                  gint yoff)
{
  if (! tile->rowhint)
    return 0;
# 60 "/src/gimp-2.6.7/app/base/tile-rowhints.c"
...
tile_set_rowhint (Tile *tile,
                  ...
                  TileRowHint rowhint)
{
# 80 "/src/gimp-2.6.7/app/base/tile-rowhints.c"
...
# 150 "/src/gimp-2.6.7/app/base/tile-rowhints.c"
          if (hint == 0)
            {
    ...
    case 2:
      ...
      for (y = start; y < start + rows; y++)
        {
          TileRowHint hint = tile_get_rowhint (tile, y);
# 225 "/src/gimp-2.6.7/app/base/tile-rowhints.c"
          if (hint == 0)
            {
    ...
    default:
      do{ g_log ("Gimp-Base", G_LOG_LEVEL_CRITICAL, "file %s: line %d (%s): should not be reached", "/src/gimp-2.6.7/app/base/tile-rowhints.c", 260, ((const char*) (__func__))); return; }while (0);
      break;
    }
}
