# 1 "/src/gimp-2.6.7/app/base/boundary.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/app/base/boundary.c"
# 19 "/src/gimp-2.6.7/app/base/boundary.c"
# 1 "../../config.h" 1
# 20 "/src/gimp-2.6.7/app/base/boundary.c" 2
...
# 22 "/src/gimp-2.6.7/app/base/boundary.c" 2
...
# 23 "/src/gimp-2.6.7/app/base/boundary.c" 2
...
# 25 "/src/gimp-2.6.7/app/base/boundary.c" 2
...
# 27 "/src/gimp-2.6.7/app/base/boundary.c" 2
...
# 29 "/src/gimp-2.6.7/app/base/boundary.c" 2

# 1 "/src/gimp-2.6.7/app/base/boundary.h" 1
# 27 "/src/gimp-2.6.7/app/base/boundary.h"
typedef enum
{
...
BoundSeg * boundary_simplify (BoundSeg *sorted_segs,
                               gint num_groups,
                               gint *num_segs);
# 31 "/src/gimp-2.6.7/app/base/boundary.c" 2
...
# 32 "/src/gimp-2.6.7/app/base/boundary.c" 2
...
void tile_detach (Tile *tile,
                                  void *tm,
                                  gint tile_num);
# 33 "/src/gimp-2.6.7/app/base/boundary.c" 2
...
void write_pixel_data_1 (TileManager *tm,
                                      ...
                                      gint y,
                                      const guchar *buffer);
# 34 "/src/gimp-2.6.7/app/base/boundary.c" 2
...
static void simplify_subdivide (const BoundSeg *segs,
                                       ...
                                       gint end_idx,
                                       GArray **ret_points);
# 155 "/src/gimp-2.6.7/app/base/boundary.c"
BoundSeg *
               ...
               int *num_segs)
{
  ...
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((maskPR != 
# 167 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
 ((void *)0)
# 167 "/src/gimp-2.6.7/app/base/boundary.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "maskPR != NULL"); return (
# 167 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
 ((void *)0)
# 167 "/src/gimp-2.6.7/app/base/boundary.c"
 ); }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((num_segs != 
# 168 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
 ((void *)0)
# 168 "/src/gimp-2.6.7/app/base/boundary.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "num_segs != NULL"); return (
# 168 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
 ((void *)0)
# 168 "/src/gimp-2.6.7/app/base/boundary.c"
 ); }; }while (0);
...
# 190 "/src/gimp-2.6.7/app/base/boundary.c"
BoundSeg *
               ...
               gint *num_groups)
{
  ...
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (((segs == 
# 202 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
 ((void *)0) 
# 202 "/src/gimp-2.6.7/app/base/boundary.c"
 && num_segs == 0) || (segs != 
# 202 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
 ((void *)0) 
# 202 "/src/gimp-2.6.7/app/base/boundary.c"
 && num_segs > 0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "(segs == NULL && num_segs == 0) || (segs != NULL && num_segs > 0)"); return (
# 202 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
 ((void *)0)
# 202 "/src/gimp-2.6.7/app/base/boundary.c"
 ); }; }while (0)
                                                              ;
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((num_groups != 
# 204 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
 ((void *)0)
# 204 "/src/gimp-2.6.7/app/base/boundary.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "num_groups != NULL"); return (
# 204 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
 ((void *)0)
# 204 "/src/gimp-2.6.7/app/base/boundary.c"
 ); }; }while (0);
  ...
  *num_groups = 0;
  ...
  if (num_segs == 0)
    return 
# 209 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
          ((void *)0)
# 209 "/src/gimp-2.6.7/app/base/boundary.c"
              ;


  segs_ptrs_by_xy1 = (const BoundSeg * *) (__extension__ ({ gsize __n = (gsize) (num_segs); gsize __s = sizeof (const BoundSeg *); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 212 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
                    (0x7fffffffffffffffL * 2UL + 1UL) 
# 212 "/src/gimp-2.6.7/app/base/boundary.c"
                    / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
  segs_ptrs_by_xy2 = (const BoundSeg * *) (__extension__ ({ gsize __n = (gsize) (num_segs); gsize __s = sizeof (const BoundSeg *); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 213 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
                    (0x7fffffffffffffffL * 2UL + 1UL) 
# 213 "/src/gimp-2.6.7/app/base/boundary.c"
                    / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
...
# 229 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
                          ((void *)0)
# 229 "/src/gimp-2.6.7/app/base/boundary.c"
                              );
  ...
  for (index = 0; index < num_segs; index++)
    {
      ...
      while ((cur_seg = find_segment (segs_ptrs_by_xy1, segs_ptrs_by_xy2,
                                      num_segs, x, y)) != 
# 251 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
                                                         ((void *)0)
# 251 "/src/gimp-2.6.7/app/base/boundary.c"
                                                             )
        {
      ...
      if ((__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((x != startx || y != starty)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 0)))
        g_log ("Gimp-Base", G_LOG_LEVEL_WARNING, "sort_boundary(): Unconnected boundary group!");
...
# 302 "/src/gimp-2.6.7/app/base/boundary.c"
BoundSeg *
                   ...
                   gint *num_segs)
{
  ...
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (((sorted_segs == 
# 310 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
 ((void *)0) 
# 310 "/src/gimp-2.6.7/app/base/boundary.c"
 && num_groups == 0) || (sorted_segs != 
# 310 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
 ((void *)0) 
# 310 "/src/gimp-2.6.7/app/base/boundary.c"
 && num_groups > 0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "(sorted_segs == NULL && num_groups == 0) || (sorted_segs != NULL && num_groups > 0)"); return (
# 310 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
 ((void *)0)
# 310 "/src/gimp-2.6.7/app/base/boundary.c"
 ); }; }while (0)
                                                                       ;
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((num_segs != 
# 312 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
 ((void *)0)
# 312 "/src/gimp-2.6.7/app/base/boundary.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "num_segs != NULL"); return (
# 312 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
 ((void *)0)
# 312 "/src/gimp-2.6.7/app/base/boundary.c"
  ...
  if (PR)
    {
      ...
      boundary->vert_segs = (gint *) (__extension__ ({ gsize __n = (gsize) (PR->w + PR->x + 1); gsize __s = sizeof (gint); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 380 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
                           (0x7fffffffffffffffL * 2UL + 1UL) 
# 380 "/src/gimp-2.6.7/app/base/boundary.c"
                           / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
      ...
      boundary->empty_segs_n = (gint *) (__extension__ ({ gsize __n = (gsize) (boundary->max_empty_segs); gsize __s = sizeof (gint); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 390 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
                              (0x7fffffffffffffffL * 2UL + 1UL) 
# 390 "/src/gimp-2.6.7/app/base/boundary.c"
                              / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
      boundary->empty_segs_c = (gint *) (__extension__ ({ gsize __n = (gsize) (boundary->max_empty_segs); gsize __s = sizeof (gint); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 391 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
                              (0x7fffffffffffffffL * 2UL + 1UL) 
# 391 "/src/gimp-2.6.7/app/base/boundary.c"
                              / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
      boundary->empty_segs_l = (gint *) (__extension__ ({ gsize __n = (gsize) (boundary->max_empty_segs); gsize __s = sizeof (gint); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 392 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
                              (0x7fffffffffffffffL * 2UL + 1UL) 
# 392 "/src/gimp-2.6.7/app/base/boundary.c"
                              / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
    }
...
{
  BoundSeg *segs = 
# 402 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
                  ((void *)0)
# 402 "/src/gimp-2.6.7/app/base/boundary.c"
                      ;
  ...
  if (boundary->num_segs >= boundary->max_segs)
    {
      ...
      boundary->segs = (BoundSeg *) (__extension__ ({ gsize __n = (gsize) (boundary->max_segs); gsize __s = sizeof (BoundSeg); gpointer __p = (gpointer) (boundary->segs); if (__s == 1) __p = g_realloc (__p, __n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 431 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
                      (0x7fffffffffffffffL * 2UL + 1UL) 
# 431 "/src/gimp-2.6.7/app/base/boundary.c"
...
{
  const guchar *data = 
# 456 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
                       ((void *)0)
# 456 "/src/gimp-2.6.7/app/base/boundary.c"
                           ;
  Tile *tile = 
# 457 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
                       ((void *)0)
# 457 "/src/gimp-2.6.7/app/base/boundary.c"
                           ;
  gint start = 0;
  gint end = 0;
  gint endx = 0;
              ...
              gint y)
{
  ...
  if (segptr_xy1 != 
# 855 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
                   ((void *)0) 
# 855 "/src/gimp-2.6.7/app/base/boundary.c"
                        && segptr_xy2 != 
# 855 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
                                         ((void *)0)
# 855 "/src/gimp-2.6.7/app/base/boundary.c"
...
# 857 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
                        ((void *)0)
# 857 "/src/gimp-2.6.7/app/base/boundary.c"
                            )
    return segptr_xy1;
  else if (segptr_xy2 != 
# 859 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
                        ((void *)0)
# 859 "/src/gimp-2.6.7/app/base/boundary.c"
                            )
    return segptr_xy2;

  return 
# 862 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
        ((void *)0)
# 862 "/src/gimp-2.6.7/app/base/boundary.c"
            ;
}
...
{
  const BoundSeg **seg;
  const BoundSeg *found_seg = 
# 873 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
                             ((void *)0)
# 873 "/src/gimp-2.6.7/app/base/boundary.c"
                                 ;

  seg = bsearch (&search_seg, segs, num_segs, sizeof (BoundSeg *), cmp_func);

  if (seg != 
# 877 "/src/gimp-2.6.7/app/base/boundary.c" 3 4
            ((void *)0)
# 877 "/src/gimp-2.6.7/app/base/boundary.c"
                )
    {
