# 1 "/src/gimp-2.6.7/app/base/colorize.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/app/base/colorize.c"
# 19 "/src/gimp-2.6.7/app/base/colorize.c"
# 1 "../../config.h" 1
# 20 "/src/gimp-2.6.7/app/base/colorize.c" 2
...
# 22 "/src/gimp-2.6.7/app/base/colorize.c" 2
...
# 24 "/src/gimp-2.6.7/app/base/colorize.c" 2
...
# 25 "/src/gimp-2.6.7/app/base/colorize.c" 2
...
# 27 "/src/gimp-2.6.7/app/base/colorize.c" 2

# 1 "/src/gimp-2.6.7/app/base/colorize.h" 1
# 23 "/src/gimp-2.6.7/app/base/colorize.h"
struct _Colorize
{
  gdouble hue;
  gdouble saturation;
...
void colorize (Colorize *colorize,
                           PixelRegion *srcPR,
                           PixelRegion *destPR);
# 29 "/src/gimp-2.6.7/app/base/colorize.c" 2
...
# 30 "/src/gimp-2.6.7/app/base/colorize.c" 2
...
colorize_init (Colorize *colorize)
{
  ...
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((colorize != 
# 37 "/src/gimp-2.6.7/app/base/colorize.c" 3 4
 ((void *)0)
# 37 "/src/gimp-2.6.7/app/base/colorize.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "colorize != NULL"); return; }; }while (0);
...
colorize_calculate (Colorize *colorize)
{
  ...
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((colorize != 
# 58 "/src/gimp-2.6.7/app/base/colorize.c" 3 4
 ((void *)0)
# 58 "/src/gimp-2.6.7/app/base/colorize.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "colorize != NULL"); return; }; }while (0);
