# 1 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
...
# 1 "<command-line>" 2
# 1 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
# 20 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
# 1 "../config.h" 1
# 21 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 2
...
# 23 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 2
...
# 25 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 2
...
# 27 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 2

# 1 "/src/gimp-2.6.7/libgimpmodule/gimpmoduletypes.h" 1
# 23 "/src/gimp-2.6.7/libgimpmodule/gimpmoduletypes.h"

# 37 "/src/gimp-2.6.7/libgimpmodule/gimpmoduletypes.h"
...
# 29 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 2
...
# 151 "/src/gimp-2.6.7/libgimpmodule/gimpmodule.h"
...
# 31 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 2
# 1 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.h" 1
# 32 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 2
...
gimp_module_db_class_init (GimpModuleDBClass *klass)
{
  ...
  db_signals[ADD] =
    g_signal_new ("add",
                  ...
                  G_SIGNAL_RUN_FIRST,
                  ((glong) 
# 83 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
                 __builtin_offsetof (
# 83 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
                 GimpModuleDBClass
# 83 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
                 , 
# 83 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
...
# 84 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
                 ((void *)0)
# 84 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
                     , 
# 84 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
                       ((void *)0)
# 84 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
  ...
  db_signals[REMOVE] =
    g_signal_new ("remove",
                  ...
                  G_SIGNAL_RUN_FIRST,
                  ((glong) 
# 93 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
                 __builtin_offsetof (
# 93 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
                 GimpModuleDBClass
# 93 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
                 , 
# 93 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
...
# 94 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
                 ((void *)0)
# 94 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
                     , 
# 94 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
                       ((void *)0)
# 94 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
  ...
  db_signals[MODULE_MODIFIED] =
    g_signal_new ("module-modified",
                  ...
                  G_SIGNAL_RUN_FIRST,
                  ((glong) 
# 103 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
                 __builtin_offsetof (
# 103 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
                 GimpModuleDBClass
# 103 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
                 , 
# 103 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
...
# 104 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
                 ((void *)0)
# 104 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
                     , 
# 104 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
                       ((void *)0)
# 104 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
  ...
  klass->add = 
# 111 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
                          ((void *)0)
# 111 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
                              ;
  klass->remove = 
# 112 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
                          ((void *)0)
# 112 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
                              ;
}
...
{
  db->modules = 
# 118 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
                    ((void *)0)
# 118 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
                        ;
  db->load_inhibit = 
# 119 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
                    ((void *)0)
# 119 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
                        ;
  db->verbose = (0);
}
  ...
  if (db->modules)
    {
      ...
      db->modules = 
# 131 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
                   ((void *)0)
# 131 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
                       ;
    }
  ...
  if (db->load_inhibit)
    {
      ...
      db->load_inhibit = 
# 137 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
                        ((void *)0)
# 137 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
                            ;
    }

  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_module_db_parent_class)), (((GType) ((20) << (2))))))))->finalize (object);
}
# 152 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
GimpModuleDB *
gimp_module_db_new (gboolean verbose)
{
  GimpModuleDB *db;

  db = g_object_new ((gimp_module_db_get_type ()), 
# 157 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
                                         ((void *)0)
# 157 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
                                             );
...
# 209 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
void
                                 ...
                                 const gchar *load_inhibit)
{
  ...
  for (list = db->modules; list; list = ((list) ? (((GList *)(list))->next) : 
# 222 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
                                       ((void *)0)
# 222 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
                                       ))
    {
...
# 241 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
const gchar *
gimp_module_db_get_load_inhibit (GimpModuleDB *db)
{
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((db)); GType __t = ((gimp_module_db_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimpModule", ((const char*) (__func__)), "GIMP_IS_MODULE_DB (db)"); return (
# 244 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
 ((void *)0)
# 244 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
 ); }; }while (0);

  return db->load_inhibit;
}
# 259 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
void
gimp_module_db_load (GimpModuleDB *db,
                     const gchar *module_path)
{
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((db)); GType __t = ((gimp_module_db_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimpModule", ((const char*) (__func__)), "GIMP_IS_MODULE_DB (db)"); return; }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((module_path != 
# 264 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
 ((void *)0)
# 264 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimpModule", ((const char*) (__func__)), "module_path != NULL"); return; }; }while (0);
...
# 290 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
void
gimp_module_db_refresh (GimpModuleDB *db,
                        const gchar *module_path)
{
  GList *kill_list = 
# 294 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
                    ((void *)0)
# 294 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
                        ;

  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((db)); GType __t = ((gimp_module_db_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimpModule", ((const char*) (__func__)), "GIMP_IS_MODULE_DB (db)"); return; }; }while (0);
  do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((module_path != 
# 297 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
 ((void *)0)
# 297 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
 )) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning ("LibGimpModule", ((const char*) (__func__)), "module_path != NULL"); return; }; }while (0);
                                  ...
                                  gpointer user_data)
{
  ...
  g_signal_connect_data ((module), ("modified"), (((GCallback) (gimp_module_db_module_modified))), (db), 
# 338 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
 ((void *)0)
# 338 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
 , (GConnectFlags) 0)
                                    ...
                                    const char *fullpath)
{
  ...
  for (list = db->modules; list; list = ((list) ? (((GList *)(list))->next) : 
# 352 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
                                       ((void *)0)
# 352 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
                                       ))
    {
      GimpModule *module = list->data;
  ...
  return 
# 360 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
        ((void *)0)
# 360 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
            ;
}
# 396 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
static void
  ...
  if (! module->on_disk && ! module->module)
    {
      *kill_list = g_list_append (*kill_list, module);
      module = 
# 414 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
              ((void *)0)
# 414 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
                  ;
    }
                                   ...
                                   gpointer user_data)
{
  ...
  g_signal_handlers_disconnect_matched ((module), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, 
# 428 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c" 3 4
 ((void *)0)
# 428 "/src/gimp-2.6.7/libgimpmodule/gimpmoduledb.c"
 , (gimp_module_db_module_modified), (db))
